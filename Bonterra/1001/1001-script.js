    ...
    if (body) {
      ...
      if (!body.classList.contains('spz_1001')) {
          body.classList.add('spz_1001');
              ...
              const heroSelector = `.spz_1001 .main-content .layout .layout__region`;
              const footerSelector = `.spz_1001 footer.site-footer`;
              ...
              `<div class="spz-Leading-Logos">
                  ...
                  document.querySelector('.spz_1001 #header .site-branding__logo img').src = "//res.cloudinary.com/spiralyze/image/upload/v1725601232/bonterra/1001/bonterra-logo_1.svg";
              ...
              function formModify() {
                  ...
                  var mktoForm = document.querySelector('.spz_1001 .main-content .spz-shortform-baseline form.mktoForm');
                  var mktoFormRows = document.querySelectorAll('.spz_1001 .main-content .spz-shortform-baseline form.mktoForm .mktoFormRow');
                  ...
                  var form_fields = document.querySelectorAll('.spz_1001 .main-content .spz-shortform-baseline form.mktoForm .mktoFormCol');
                      for (var i = 0; i < form_fields.length; i++) {
                      var dynamicClass = 'field-' + (i + 1);
                      form_fields[i].classList.add(dynamicClass);
                  }
                  // Remove Placeholder
                  var all_inputs = document.querySelectorAll('.spz_1001 .main-content .spz-shortform-baseline form.mktoForm .mktoFormCol .mktoFieldWrap input, .spz_1001 .main-content .spz-shortform-baseline form.mktoForm .mktoFormCol .mktoFieldWrap select');
                  ...
                  var email_field = document.querySelector('.spz_1001 .main-content .spz-shortform-baseline form.mktoForm .mktoFormCol.field-3');
                  var orgname_field = document.querySelector('.spz_1001 .main-content .spz-shortform-baseline form.mktoForm .mktoFormCol.field-6');
                  email_field.before(orgname_field);
                  // On input focus add class on closest parent field class
                  function focusFields() {
                      document.querySelectorAll(`.spz_1001 .main-content .spz-shortform-baseline form.mktoForm .mktoFormCol .mktoFieldWrap .mktoField`).forEach(function (el) {
                  ...
                  document.querySelector('.spz_1001 .main-content .spz-shortform-baseline form.mktoForm .mktoButtonRow button.mktoButton').addEventListener('click', function(event) {
                      document.querySelectorAll(`.spz_1001 .main-content .spz-shortform-baseline form.mktoForm .mktoFormCol .mktoFieldWrap .mktoField`).forEach(function (elem) {
