...
const asana_URL = `https://app.asana.com/0/1202434538289854/1208926096059700/f`
//DEV 2/6. Add content inside the box
const template_formElements = {
  customHTMLBefore: `
	${ /*This html goes is inserted before the form */'' }
	  <div class="spz-company-logo"><img src="https://res.cloudinary.com/spiralyze/image/upload/v1726515821/Code_Templates_assets/Form_Over_UI/placholder_logo.svg"/></div>
  `,
  customHTMLAfter: ``,
};
...
const template_formUniqueSelector = "#mktoForm_1024" 
...
const template_inputsSelectors = ["#FirstName", "#LastName", "#Email", "#Phone", "#Industry", "#Company", "#capability", "#Number_of_Employees_Range__c", "#City", "#Zip"]

//DEV 5/6. Add Form labels below
const template_labelValues = ["First Name", "Last Name", "Email Address", "Phone Number", "Organization Type", "Organization Name", "What are you looking for?", "Organization Size", "City", "Zip"] 
