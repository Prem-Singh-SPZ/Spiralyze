...
function hero_modify() {
    document.querySelector('h1.h2').insertAdjacentHTML('afterend', '<div class="hero-copy"><p>Traditional approaches to sales and go-to-market strategic planning are no longer effective. To succeed in today&#8217;s markets, you must be able to embrace change and adopt the new drivers of sales team success.</p><p><span class="fw-semibold">Ready to learn how?</span> This research shares insights on the current state of how sales and revenue leaders can set their teams up for success in today&#8217;s change intensive environment.</p></div>');
