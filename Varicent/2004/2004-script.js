    ...
    if (body) {
        ...
        if (!body.classList.contains('spz-2004')) {
            ...
            waitForElm('.spz-2004 .row-number-1 .widget-type-rich_text .hs_cos_wrapper.hs_cos_wrapper_widget').then(function () {
                ...
                document.querySelectorAll('body.spz-2004 #main-content .row-number-1 > .row-fluid > .widget-type-cell:first-child .widget-type-rich_text .hs_cos_wrapper_type_rich_text > p').forEach(function (elm, index) {
                    if(index == 0){
                        elm.innerHTML = '<span style="color: #ffffff;">Traditional sales and go-to-market planning efforts are failing. <br>To succeed in today’s markets, you must be able to embrace change and adopt the new drivers of sales team success.</span>'
                    }
