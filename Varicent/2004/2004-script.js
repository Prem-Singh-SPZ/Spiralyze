    ...
    if (body) {
        ...
        if (!body.classList.contains('spz-2004')) {
            ...
            waitForElm('.spz-2004 .row-number-1 .widget-type-rich_text .hs_cos_wrapper.hs_cos_wrapper_widget').then(function () {
                ...
                document.querySelector('.spz-2004 .row-number-1 .widget-type-rich_text .hs_cos_wrapper.hs_cos_wrapper_widget').insertAdjacentHTML('afterend', '<div class="spz-social-count"><div class="social-count-inner"><div class="social-dark"><img src="//res.cloudinary.com/spiralyze/image/upload/v1723752765/varicent/2004/icon.svg">In high demand!</div><div class="social-light"><span class="d-md-block d-none">Downloaded 342 times in the last week.</span><span class="d-md-none">342 downloads last week.</span></div></div></div>');
