...
if (!bodyElem.classList.contains('SFL_1067')) {
	bodyElem.classList.add('SFL_1067');
						...
						<div class="market-desc">
							...
							<div class="ani-button">
								...
								<div class="ani-button-container">
									<div class="price-ai">Or, <a class="dummy-CTA price" href="javascript:void(0)">Get Pricing</a></div>
								</div>
							</div>
						</div>
					</div>
	...
	var fsFormInterval = setInterval(function () {
		...
		if (emailInputs.length > 0) {
			...
			emailInputs.forEach(function (emailInput) {
				var fieldWrapper = this.document.querySelector('.spzFieldWrapper');
				...
				if (emailInput && fieldWrapper) {
					...
					emailInput.addEventListener('keypress', function (e) {
						if (e.which === 13 || e.key === 'Enter') {
							document.querySelector('.ai-demo a').click();
						}
					});
				}
			});
