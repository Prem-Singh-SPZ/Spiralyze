(function () {
    ...
    function checkAvailable() {
        var checkLoad = setInterval(function () {
            if (jQuery("#results-container").find('.vms-results-item')) {
                ...
                document.querySelector('#results-container').insertAdjacentHTML('beforebegin', `<div class="featured-products-spz vms-results__container"></div>`);
    ...
    function getData() {
        fetch('https://smokymountains.com/search/?srt=RHF').then(function (response) {
