...
$(`#element-647 form input#${formInputId}-3, #element-647 form label[for="${formInputId}-3"]`).wrapAll('<div class="input_field field-3"></div>');
...
var selector = '#element-647 form input, #element-647 form select';
...
$(`input#${formInputId}-26-01`).change(function () {
...
var websiteInput = document.getElementById(`${formInputId}-3`);
