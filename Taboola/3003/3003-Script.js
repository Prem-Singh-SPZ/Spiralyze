...
var jQueryInterval = setInterval(function () {
    if (typeof jQuery != 'undefined') {
        ...
        var vInt = setInterval(() => {
            ...
            <picture>
                <source srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/taboola/3003/preview-desk_1.webp" type="image/webp">
                <source srcset="//res.cloudinary.com/spiralyze/image/upload/v1689944076/taboola/3003/preview-desk_1.png" type="image/png"> 
                <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/taboola/3003/preview-desk_1.webp" alt="Find right audience at low CPA" draggable="false" class="hero-poster-video-bg">
                </picture>
                <a href="javascript:void(0)" id="play-btn-hero" class="play-btn-hero"> <img class="play-btn-spz-hero" src="//res.cloudinary.com/spiralyze/image/upload/v1690277730/Taboola/3003/custom/assets/play-button.svg" alt="Play" /> </a>
            </div>
        </div>`);
            ...
            <div class="hero-modal-content">
              <div class="modal-container">
                ...
                <img class="close-modal" src="//res.cloudinary.com/spiralyze/image/upload/v1690361425/Taboola/3003/custom/assets/icon-close.svg" alt="Close" />
                <img class="close-modal-hover" src="//res.cloudinary.com/spiralyze/image/upload/v1690361425/Taboola/3003/custom/assets/icon-close-hover.svg" alt="Close" />
                </div>
