(function () {
    ...
    function restructureForm() {
        ...
        waitForElm(`.spz-ispartner`).then(function (elm) {
            document.querySelector('body.spz-3004 .mktoFormCol.spz-ispartner').insertAdjacentElement('beforebegin', document.querySelector('body.spz-3004 form.mktoForm .mktoFormCol .mktoFieldWrap .mktoHtmlText'));
            document.querySelector('body.spz-3004 .mktoFormCol.spz-lastname').insertAdjacentElement('afterend', document.querySelector('body.spz-3004 form.mktoForm .mktoFormCol.spz-phone'));
            document.querySelector('body.spz-3004 form.mktoForm .mktoButtonRow').insertAdjacentElement('afterend', document.querySelector('body.spz-3004 form.mktoForm .mktoCaptchaDisclaimer'));

            document.querySelector('body.spz-3004 #Company_Size__c option[value=""]').textContent = 'Company Size';
            document.querySelector('body.spz-3004 form.mktoForm .mktoButton').textContent = 'Submit';
            // document.querySelector('body.spz-3004 form.mktoForm #Person_Country__c').setAttribute('autocomplete', 'dont');
            ...
            document.querySelector('body.spz-3004 form.mktoForm #FirstName').setAttribute('tabindex', 2);
            document.querySelector('body.spz-3004 form.mktoForm #LastName').setAttribute('tabindex', 3);
            document.querySelector('body.spz-3004 form.mktoForm #Phone').setAttribute('tabindex', 4);
            document.querySelector('body.spz-3004 form.mktoForm #Company').setAttribute('tabindex', 5);
            document.querySelector('body.spz-3004 form.mktoForm #Company_Size__c').setAttribute('tabindex', 6);
            document.querySelector('body.spz-3004 form.mktoForm #Person_Country__c').setAttribute('tabindex', 7);
            document.querySelector('body.spz-3004 form.mktoForm .mktoHtmlText.mktoHasWidth a').setAttribute('tabindex', 8);
        ...
        hiddenValue('#3004 | Expel | Pricing | Form Over Pricing', 'variant_#3004');
    }
