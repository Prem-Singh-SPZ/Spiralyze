    ...
    if (body) {
        ...
        if (!body.classList.contains('spz-3003')) {
            ...
            waitForElm('#hero-section').then(function () {
                ...
                // Form Title
                document.querySelector('#hero-section .hero  .form-title').textContent = "Get Pricing";

                // Form Reviews and Gartner
                document.querySelector('.spz-3003 #hero-section .hero .spz-content + .col').insertAdjacentHTML('afterend', `
