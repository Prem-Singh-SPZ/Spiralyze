  ...
  if (body) {
    ...
    if (!body.classList.contains('spz-3003')) {
      ...
      waitForElm('#hero-section').then(function () {
        ...
        document.querySelectorAll('#stats-2-col .col.stats .single-stat a')[0].innerHTML = `<div class="gartner-wrapper ss-card"><div class="logo-img"><img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/expel/3003/g2_crowd_5.svg" alt="Gartner Insights"></div><div class="google-rating"><img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/expel/3003/stars_2.svg" alt="Rating"></div>`;
