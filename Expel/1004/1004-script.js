(function () {
    var css = `.spz-1004-v2 section#quotes-slider {
			display: none;
		}

		.spz-1004-v2 .spz-testimonials {
			margin-top: 18px;
		}

		.spz-1004-v2 .spz-testimonials-wrapper {
			width: 100%;
			margin: 0 auto;
		}

		.spz-1004-v2 .spz-testimonials .demo-cta {
			display: flex;
			flex-wrap: wrap;
			align-items: center;
		...
		.spz-1004-v2 .spz-testimonials .demo-cta:hover {
			background: #0E4C8A;
		}

		.spz-1004-v2 .spz-testimonials .demo-cta svg {
			margin-left: 8px;
		}

		.spz-1004-v2 .spz-testimonials .splide {
			position: relative;
		}

		.spz-1004-v2 .spz-testimonials .splide::before,
		.spz-1004-v2 .spz-testimonials .splide::after {
			position: absolute;
			content: "";
			width: 281px;
		...
		.spz-1004-v2 .spz-testimonials .testimonial-item {
			background: #F4F4F4;
			border-radius: 16px;
			padding: 32px;
		}

		.spz-1004-v2 .testimonial-item .testimonial-copy {
			display: flex;
			flex-wrap: wrap;
		...
		.spz-1004-v2 .testimonial-item .author-content {
			display: flex;
			flex-wrap: nowrap;
			flex-flow: row;
			align-items: center;
		...
		.spz-1004-v2 .testimonial-item .author-content .author-name {
			color: #031263;
			font-size: 18px;
			font-style: normal;
			font-weight: 700;
		...
		.spz-1004-v2 .testimonial-item .author-content .author-designation {
			color: #031263;
			font-size: 16px;
			font-style: normal;
			font-weight: 400;
		...
		.spz-1004-v2 .testimonial-item .author-content .author-company {
			display: inline-flex;
			width: auto;
			height: auto;
		}

		.spz-1004-v2 .testimonial-item .author-content .company-logo {
			width: auto;
			height: 46px;
			object-fit: contain;
		}
		...
		@media (max-width: 767.98px) {
			.spz-1004-v2 .spz-testimonials .splide__arrows {
				display: flex;
				flex-wrap: wrap;
				justify-content: space-between;
				width: 100%;
			...
			.spz-1004-v2 .spz-testimonials .splide__arrow {
				position: relative;
				width: 56px;
				height: 56px;
				left: unset;
			...
			.spz-1004-v2 .spz-testimonials .splide__arrow.splide__arrow--next {
		...
		@media (min-width: 767.98px) {
			.spz-1004-v2 .spz-testimonials .splide__arrows .splide__arrow {
				/* display: flex; */
				/* flex-wrap: wrap; */
				/* justify-content: space-between; */
				/* width: 100%; */
			...
			.spz-1004-v2 .spz-testimonials .splide__arrow.splide__arrow--prev {
				top: calc(50% - 28px);
				left: 20px;
			}
		...
		.spz-1004-v2 .spz-testimonials .splide__arrow:hover {
			border: 2px solid #0E4C8A;
		}

		.spz-1004-v2 .spz-testimonials .splide__arrow svg {
			transform: none;
			width: 100%;
			height: 100%;
		}

		.spz-1004-v2 .spz-testimonials .splide__arrow svg path {
			transition: 200ms ease all;
		}

		.spz-1004-v2 .spz-testimonials .splide__arrow:hover svg path {
			fill: #0E4C8A;
		}

		.spz-1004-v2 .spz-testimonials .splide__pagination {
			bottom: -36px;
			padding: 0;
		}

		.spz-1004-v2 .spz-testimonials .splide__pagination li {
			display: inline-flex;
		}

		.spz-1004-v2 .spz-testimonials .splide__pagination button {
			width: 50px;
			height: 4px;
			border-radius: 8px;
			background: #1762E6;
		...
		.spz-1004-v2 .spz-testimonials .splide__pagination button.is-active {
			opacity: 1;
		}

		.spz-1004-v2 .icon-boxes-vertical {
			padding-top: 131px;
		}
    ...
    const sectionSelector = `.spz-1004-v2 #logos-slider`
    ...
    let bodyLoaded = setInterval(function () {
        ...
        if (body) {
            ...
            if (!body.classList.contains('spz-1004-v2')) {
                body.classList.add('spz-1004-v2', 'tc-1008');
                ...
                hiddenValue('#1004 | Expel | Homepage | Testimonials', 'control_#1008');
            }
        }
    });
