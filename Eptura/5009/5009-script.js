...
function addPageContent() {
    ...
    document.querySelector('.form-container').insertAdjacentHTML('beforeend', `<div class="line-header"><a href="https://eptura.com/support/"><div class="header-img"><img src="//res.cloudinary.com/spiralyze/image/upload/v1718811851/eptura/5009/icon-01.svg" alt="Customer support"></div><div class="header-title"><p class="title">Customer support</p><p class="sub-title">For questions & inqueries</p></div></a></div><div class="line-header"><a href="https://eptura.com/offices/"><div class="header-img"><img src="//res.cloudinary.com/spiralyze/image/upload/v1718811851/eptura/5009/icon-03.svg" alt="Our locations"></div><div class="header-title"><p class="title">Our locations</p><p class="sub-title">For office addresses </p></div></a></div>`);
