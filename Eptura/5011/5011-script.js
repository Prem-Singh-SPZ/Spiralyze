var bodyInterval = setInterval(function () {
    ...
    if (!bodyEle.classList.contains('spz-5011')) {
        clearInterval(bodyInterval);
        document.body.classList.add('spz-5011');
...
function loadTest() {
    ...
    window.addEventListener("click", function (e) {
        ...
        if (e.target.classList.contains("show-form")) {
            document.querySelector('.get-form').classList.remove('spz-hidden');
            document.querySelector('.step-1-wrapper').classList.add('spz-hidden');
        }
    });
...
function addPageContent() {
    ...
    document.querySelector('.form-container .default-form.get-form').classList.add('spz-hidden');
