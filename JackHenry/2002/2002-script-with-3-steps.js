...
(function () {
        ...
        if (!bodyEle.classList.contains('spz-2002')) {
            ...
            waitForElm(' form.hs-form-private .hs-form-field').then(function (elm) {
                ...
                document.querySelector('.hs_cos_wrapper_type_form > h3.form-title').insertAdjacentHTML('beforebegin', `
                    <div class="form-stepper">Step <span class="current-step">1</span>/3</div>
                    <button class="back-btn" id="step-back-btn" data-prev-step="1"></button>
                `);

                // Set form title
                document.querySelector('.hs_cos_wrapper_type_form > h3.form-title').textContent = 'What kind of institution are you?';
    ...
    function appendFormSteps() {
        ...
        document.querySelector('[id*="hs_form_target_form"]').insertAdjacentHTML('beforebegin', `
            <div class="spz-step-1 active">
                <div class="d-flex flex-wrap justify-content-between form-checkboxes">
                    <!-- Custom checkbox starts -->
                    <label class="custom-checkbox-spz" for="bank_1">
                        <div class="ccs-label">Bank</div>
                        <div class="ccs-checkbox">
                            <input type="checkbox" id="bank_1" name="bank_1">
                            <span class="ccs-box"></span>
                        </div>
                    </label>
                    <!-- Custom checkbox ends -->

                    <label class="custom-checkbox-spz" for="credit_union">
                        <div class="ccs-label">Credit Union</div>
                        <div class="ccs-checkbox">
                            <input type="checkbox" id="credit_union" name="credit_union">
                            <span class="ccs-box"></span>
                        </div>
                    </label>

                    <label class="custom-checkbox-spz" for="de_novo_bank">
                        <div class="ccs-label">De Novo Bank</div>
                        <div class="ccs-checkbox">
                            <input type="checkbox" id="de_novo_bank" name="de_novo_bank">
                            <span class="ccs-box"></span>
                        </div>
                    </label>

                    <label class="custom-checkbox-spz" for="fintech">
                        <div class="ccs-label">Fintech</div>
                        <div class="ccs-checkbox">
                            <input type="checkbox" id="fintech" name="fintech">
                            <span class="ccs-box"></span>
                        </div>
                    </label>

                    <label class="custom-checkbox-spz full-width" for="other">
                        <div class="ccs-label">Other</div>
                        <div class="ccs-checkbox">
                ...
                <div class="d-flex align-items-center justify-content-center next-step-cta step-1">
                    <button class="btn btn-vibrant-cobalt nav-contact" data-step="1">Next</button>
                </div>
            </div>

            <div class="spz-step-2">
                ...
                if (document.querySelector(`.spz-step-${step}`).classList.contains('active')) {
                    ...
                    if (document.querySelectorAll(`.spz-step-${step} .custom-checkbox-spz.active`).length == 0) {
                        if (document.querySelectorAll(`.spz-step-${step} .error-message`).length == 0) {
                            document.querySelector(`.spz-step-${step} .form-checkboxes`).insertAdjacentHTML('afterend', `
