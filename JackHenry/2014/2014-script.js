...
(function () {
    ...
    var bodyInterval = setInterval(function () {
        ...
        if (!bodyEle.classList.contains('spz-2014')) {
            clearInterval(bodyInterval);
            bodyEle.classList.add('spz-2014');
            ...
            waitForElm(' form.hs-form-private .hs-form-field').then(function (elm) {
                ...
                document.querySelector('.hs_cos_wrapper_type_form form.hs-form-private .hs_comment .input .hs-fieldtype-textarea').insertAdjacentHTML('afterend', `<p class="hs-error-msg hs-main-font-element spz-custom-error">Please complete this required field.</p>`);
    ...
    // for comment field focus
    function commentFieldError(el) {
        if (el.closest('.field').classList.contains('hs_comment')) {
            elemValue = el.value.trim();
            if (elemValue && elemValue != '' && elemValue != null && elemValue != undefined) {
                el.closest('.field').classList.remove('field-error-cmnt');
            } else {
                el.closest('.field').classList.add('field-error-cmnt');
            }
        }
    }
