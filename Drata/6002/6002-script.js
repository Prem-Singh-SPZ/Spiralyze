...
function heroSection() {
    return `<div class="hero-content">
                ...
                <div class="star-rating dis-flex align-items-center">
                    <img src="//res.cloudinary.com/spiralyze/image/upload/v1682086337/drata/6002/rating-4_9.svg"
...
function socialProofSection() {
    return `<section class="logo-section">
                <div class="container">
                    <h2 class="sec-title border-title">Join <span>2,000+</span> Companies Using Drata to Automate Compliance
                    </h2>
                    <div class="ls-logo-group dis-flex flex-wrap justify-content-between">
                        ...
                        <div class="ls-logo-item">
                            <img src="//res.cloudinary.com/spiralyze/image/upload/v1680678533/drata/6001/big_id.svg"
                                class="ls-img" alt="BigID" title="BigID">
                        </div>
                        <div class="ls-logo-item">
                    ...
                    <div class="work-steps dis-flex justify-content-between flex-wrap">
                        ...
                        <div class="work-step-item">
                            <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/drata/6002/set_policies.webp"
                                class="step-img" alt="Set Policies" title="Set Policies">
                            <div class="step-content">
                                <span class="step-number">Step 2.</span>
                                <h6 class="step-title">Set Policies</h6>
                        ...
                        <div class="work-step-item">
                            <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/drata/6002/track_progress.webp"
                                class="step-img" alt="Track Progress" title="Track Progress">
                            <div class="step-content">
                                <span class="step-number">Step 3.</span>
                                <h6 class="step-title">Track Progress</h6>
                                <p class="step-info">The audit dashboard shows you know exactly what you need to do. Get
                                    compliant fast.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="review-slider dis-flex justify-content-between container">
                    ...
                    <div class="review-item-box">
                        <div class="review-content">
                            <div class="rating dis-flex">
                                <img src="//res.cloudinary.com/spiralyze/image/upload/v1682075796/drata/4002/rating-50.svg"
                                    alt="Rating Stars" title="Rating Stars" class="star-rating"> <span>5.0/5</span>
                            </div>
                            <p class="review">“Undergoing any audit is a massive lift for those being audited. The entire
                                process is confusing if not done correctly. Drata has made the process simple, easy, and
                                innovative.”</p>
                    ...
                    <div class="review-item-box">
                        <div class="review-content">
                            ...
                            <p class="review">“What really sets Drata apart is its ability to simplify and automate the often
                                complex and time-consuming process of compliance.”</p>
                    ...
                    <div class="review-item-box">
                        <div class="review-content">
                            ...
                            <p class="review">“From day one, our experience with Drata was enjoyable. They have a very well
                                thought product to help their clients achieve their compliance goals.”</p>
