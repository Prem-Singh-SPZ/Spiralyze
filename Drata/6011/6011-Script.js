const int6009 = setInterval(() => {
    if (document.querySelectorAll('.hbspt-form form').length > 0) {
        ...
        document.body.classList.add('spz-6011');
        appendPreload();
    }
}, 100);
...
function createTest() {
    ...
    setTimeout(() => {
        if (document.querySelector('.spz-6011 main') && document.querySelectorAll('.spz-6011 main input[name="cro_test_1"]').length == 0) {
            document.querySelector('.spz-6011 main').insertAdjacentHTML("beforeend", '<input type="hidden" name="cro_test_1" value="#6011__Demo(Internal)_Mobile_-_Form_On_Top">');
            document.querySelector('.spz-6011 main').insertAdjacentHTML("beforeend", '<input type="hidden" name="cro_test_2" value="Variant">');
        } else if (document.querySelector('.spz-6011 main') && document.querySelectorAll('.spz-6011 main input[name="cro_test_1"]').length == 1) {
            document.querySelector('[name="cro_test_1"]').value = "#6011__Demo(Internal)_Mobile_-_Form_On_Top";
            document.querySelector('[name="cro_test_2"]').value = "Variant";
        }
    }, 1000);
}
