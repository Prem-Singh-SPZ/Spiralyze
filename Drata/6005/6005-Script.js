    ...
    function loadTest() {
        ...
        waitForElm('.integrations-logo-slider').then(function () {
            ...
            waitForElm('.hero-section + .review-section').then(function () {
                ...
                document.querySelector('.logo-section .ls-logo-group').insertAdjacentHTML('beforebegin',`<div class="testimonial"><div class="testimonial-card"><div class="testimonial-img"><img src="//res.cloudinary.com/spiralyze/image/upload/v1687342816/drata/6005/image.webp" class="test-img" alt="Jonathan Jaffe" title="Jonathan Jaffe"></div><div class="testimonial-content"><div class="auth-name"><h3>Jonathan Jaffe</h3><h6>CISO, Lemonade</h6></div><div class="auth-review"><p>“We saved 80% of time using Drata&#8217;s continuous compliance automation. I&#8217;ve spent well over 200 hours before using Drata just in preparing for and dealing with our SOC 2 audit. Drata has been great for automating evidence collection. I find it really flexible, and I&#8217;m able to make my own control framework.” </p></div></div></div></div>`)
            });
        });
    }
