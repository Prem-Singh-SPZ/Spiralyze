(function () {
  function loadTest() {
    ...
    const formInt = setInterval(() => {
      if (document.querySelectorAll('.hs-form').length == 2) {
        ...
        // Set input label
        if (document.querySelector('[name="source__inbound_demo_"]')) {
