jQuery(document).ready(function() {
    ...
    jQuery('<link id="google-slide-css" rel="stylesheet" type="text/css" href="//res.cloudinary.com/spiralyze/raw/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/google_slider.css">').appendTo('body')
        ...
        if (jQuery('main.content hos-category').length > 0 && window.location.href === "https://www.awrusa.com/" && !jQuery('.spz-protection-section').length > 0) {
            ...
            <div class="plans-wrap">\
                <div class="plan-item">\
                    ...
                    <div class="plan-show-more">\
                        <h3>We Cover</h3>\
                        <div class="items">\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Burst pipe</div>\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Pipe damage from tree root</div>\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Leaking pipe</div>\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Excavating</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Normal wear and tear</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Equipment</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Backfilling holes</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Reseeding yard</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Inspections</div>\
                        </div>\
                    </div>\
                </div>\
                <div class="plan-item">\
                    ...
                    <div class="plan-show-more">\
                        <h3>We Cover</h3>\
                        <div class="items">\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Clogs and blockages</div>\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Permits</div>\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Excavating</div>\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Equipment</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Backfilling holes</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Reseeding yard</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Inspections</div>\
                        </div>\
                ...
                <div class="plan-item recommended">\
                    ...
                    <div class="plan-name">Water Line and <br>Sewer<br> Line Protection <br>Program</div>\
                    ...
                    <div class="plan-show-more">\
                        <h3>We Cover</h3>\
                        <div class="items">\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Clogs</div>\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Blockages</div>\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled">Leaking pipe</div>\
                            <div class="item shown"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Pipe corrosion</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Burst pipe due to normal wear and tear</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Pipe collapse</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Pipe damage from tree root</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Excavating</div>\
                            <div class="item"><img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/AWR/1023_AWR_Home_Redesign_Coverage/Filled.png" alt="Filled"> Equipment</div>\
                        </div>\
                    </div>\
                </div>\
...
<div class="close-button"></div>\
            ...
            jQuery(document).ready(function() {
                ...
                if ($(window).width() < 767) {
                    $('.items .showMore').on('click', function(event) {
                        event.preventDefault()
                        jQuery(this).closest('.items').find('.item').not('.shown').toggle(300);
                        jQuery(this).closest('.items').find('.showMore').toggleClass('showLess');
                    });
                } else {
