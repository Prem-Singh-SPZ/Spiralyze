...
// content.src = 'http://127.0.0.1:5500/AWR/5001/product_thumbs.js';
content.src = 'https://res.cloudinary.com/spiralyze/raw/upload/f_auto/AWR/5001/product_thumbs.js';
...
function cartSection() {
    const cartInt = setInterval(() => {
        ...
        if (cartContent != null && document.querySelector('.card-body-box .product-name') != null) {
            ...
            if (!is_payment) {
                document.querySelector('.payment-gateway.mobile-only').remove();
            ...
            jQuery('.payment-box .card-body .media-icon').removeAttr('class').addClass('col-2 col-sm-2 col-md-2 col-lg-2 col-xl-3 text-center media-icon');
                    ...
                    if (relProducts) {
                        relProducts.filter(item => {
                            if (cardItem.children[0] && cardItem.children[0].innerText === item.productFilterName) {
                                cardItem.parentElement.parentElement.children[0].children[0].src = item.thumbImage;
                                cardItem.parentElement.parentElement.children[0].children[0].alt = item.productFilterName;
    ...
    if (document.querySelectorAll('.form-wrapper-spz').length == 0 && document.querySelectorAll('.right-form-box .general-information').length > 0) {
        ...
        waitForElement('.pad-btn-checkout').then(function () {
            ...
            if (document.querySelectorAll('.back-spz').length == 0) {
                ...
                <a href="javascript:void(0)" class="back-spz" onclick="history.back()">
                    <img src="//res.cloudinary.com/spiralyze/image/upload/v1660033776/AWR/5001/arrow-back.svg" class="img-fluid" />
                    Back
                </a>`);
            }
...
function removeInputFields() {
    if (document.querySelectorAll('.general-information input').length > 0) {
...
window.addEventListener('click', function (e) {
    if (e.target.classList.contains('cart-link')) {
        ...
        const paceLoadInt = setInterval(function () {
            if (document.querySelector('.pace') && document.querySelector('.pace').classList.contains('pace-inactive')) {
                loadTest();
            }
        }, 100);
        this.setTimeout(function () {
    ...
    if (e.target.classList.contains('cross-btn-remove') || e.target.classList.contains('ga-track-remove-product')) {
        otherProduct();
        scrollShadow();
        setTimeout(function () {
...
// // Loading files
// //addScript('https://res.cloudinary.com/spiralyze/raw/upload/f_auto/AWR/5001/script.min.js');
// addCSS('https://res.cloudinary.com/spiralyze/raw/upload/f_auto/AWR/5001/style.min.css');
