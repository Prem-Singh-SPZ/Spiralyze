...
// #4015 Variant Changes Start
function load4015() {
    let hero_html = `
        <section class="spz-sf-pricing" data-active="annual">
            <div class="spz-sf-pricing-wrap">
                <div class="spz-sf-pricing-content">
                    <h1 class="spz-sf-pricing-title">Pricing</h1>                    
                    <div class="spz-sf-hero-toggle-wrap">
                        <div class="spz-sf-hero-toggle">
                            <div class="spz-sf-hero-toggle-label" data-price="monthly">
                                <label>Monthly</label>
                            </div>
                            <div class="spz-sf-hero-toggle-item">
                                <button type="button" data-active="annual" class="spz-pricing-toggle"></button>
                            </div>
                            <div class="spz-sf-hero-toggle-label active" data-price="annual">
                                <label>Annual</label>
                                <span>Save 15%</span>
                            </div>
                        </div>
                ...
                <div class="spz-sf-hero-pricing">
                    <div class="spz-sf-hero-pricing-row active" id="pricing-annual">
                        <div class="swiper-wrapper">
                            <div class="spz-sf-hero-pricing-box swiper-slide">
                                <div class="spz-pricing-box-wrap">
                                    <div class="spz-pricing-box-content">
                                        <h4>Starter</h4>
                                        <p>Basic scheduling, dispatch, and customer management</p>
                                    </div>
                                    <div class="spz-pricing-box-info">
                                        <span class="spz-pricing-discount">-15%</span>
                                        <div class="spz-pricing-price-row">
                                            <div class="spz-pricing-price"><span class="spz-plan-prc-annual">$192</span><span class="spz-plan-prc-monthly">$225</span></div>
                                            <div class="spz-pricing-price-label"><span class="hide-monthly">Per</span><span>Month</span></div>
                                            <div class="spz-pricing-price-old">$225</div>
                                        </div>
                                        <div class="spz-pricing-note-row">
                                            Unlimited Users
                                        </div>
                                        <div class="spz-pricing-cta-row">
                                            <button type="button" class="spz-pricing-cta spz_4015_v1">Get Free Demo</button>
                                        </div>
                                    </div>
                                    <div class="spz-pricing-box-features">
                                        <p>Includes:</p>
                                        <ul>
                                            <li>Customer Management</li>
                                            <li>Estimates & Jobs</li>
                                            <li>Schedule & Dispatching</li>
                                            <li>QuickBooks Integration</li>
                                            <li>Invoicing & Payment Processing</li>
                                            <li>Project Management & Reporting</li>
                                            <li>Text Messaging Alerts</li>
                                            <li>Estimate Options</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="spz-sf-hero-pricing-box swiper-slide popular-pricing">
                                <div class="spz-pricing-box-wrap">
                                    <div class="spz-pricing-popular"><span>MOST POPULAR</span></div>
                                    <div class="spz-pricing-box-content">
                                        <h4>Plus</h4>
                                        <p>Adds inventory management, job costing, and photo uploads</p>
                                    </div>
                                    <div class="spz-pricing-box-info">
                                        <span class="spz-pricing-discount">-15%</span>
                                        <div class="spz-pricing-price-row">
                                            <div class="spz-pricing-price"><span class="spz-plan-prc-annual">$298</span><span class="spz-plan-prc-monthly">$350</span></div>
                                            <div class="spz-pricing-price-label"><span class="hide-monthly">Per</span><span>Month</span></div>
                                            <div class="spz-pricing-price-old">$350</div>
                                        </div>
                                        <div class="spz-pricing-note-row">
                                            Unlimited Users
                                        </div>
                                    ...
                                    <div class="spz-pricing-box-features">
                                        <p>Everything in Starter, and:</p>
                                        <ul>                                            
                                            <li>Job Photo Uploads</li>
                                            <li>Inventory Management</li>
                                            <li>Job Costing</li>
                                            <li>Integrated Voice & Text</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="spz-sf-hero-pricing-box swiper-slide">
                                <div class="spz-pricing-box-wrap">
                                    <div class="spz-pricing-box-content">
                                        <h4>Pro</h4>
                                        <p>Adds eSignatures, customer web portals, and recurring invoicing</p>
                                    </div>
                                    <div class="spz-pricing-box-info">
                                        <span class="spz-pricing-discount">-15%</span>
                                        <div class="spz-pricing-price-row">
                                            <div class="spz-pricing-price"><span class="spz-plan-prc-annual">$489</span><span class="spz-plan-prc-monthly">$575</span></div>
                                            <div class="spz-pricing-price-label"><span class="hide-monthly">Per</span><span>Month</span></div>
                                            <div class="spz-pricing-price-old">$575</div>
                                        </div>
                                        <div class="spz-pricing-note-row">
                                            Unlimited Users
                                        </div>
                                    ...
                                    <div class="spz-pricing-box-features">
                                        <p>Everything in Starter & Plus, and:</p>
                                        <ul>                                                                                        
                                            <li>Open API Integration</li>
                                            <li>Custom Documents</li>
                                            <li>eSign Documents</li>
                                            <li>Customer Web Portal </li>
                                            <li>Progress Billing & Recurring Invoicing</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
