...
if(!document.querySelector('.spz-2002')){
  ...
  document.addEventListener('click', function(e) {
      if(e.target.closest("a") && e.target.closest("a").getAttribute('href') === '#popup_request_a_demo'){
        if(document.querySelector('.spz-2002 #new-formDemo-wrapper .submitted-message')){
          ...
          /*
          if(document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper .error-message.show')){
            document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper .error-message.show').classList.remove("show")  
          }
          if(document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper .error-message.show')){
            document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper .error-message.show').classList.remove("show")  
          }
          if(document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper .selected')){
            document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper .selected').classList.remove('selected')
          }
          if(document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper .selected')){
            document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper .selected').classList.remove('selected')
          }
          document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper').classList.remove("hide");
          document.querySelector('.spz-2002 #new-formDemo-wrapper').classList.remove("show")
          */
          loadDemoForm();
          if(document.querySelector('.spz-2002 #new-formDemo-wrapper.step2')){
            document.querySelector('.spz-2002 #new-formDemo-wrapper.step2').classList.remove("step2")
          }
        }
        let i=0;
        const CROInterval = setInterval(() => {
          if(document.querySelector('.spz-2002 #new-formDemo-wrapper input[name="cro1"]')){
            ...
            document.querySelector('.spz-2002 #new-formDemo-wrapper input[name="cro1"]').value="2004_variant"
          }
          i++;
          if(i>6){
            clearInterval (CROInterval)
  ...
  // for step
  document.querySelector('.spz-2002 #popup_request_a_demo .wcs-popup-heading').insertAdjacentHTML("afterend",`
  ...
  `)
  document.querySelector('.spz-2002 #popup_request_a_demo .step-wrapper .next-1').addEventListener("click",function(){
    if(!(document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper .selected'))){
      document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper .error-message').classList.add('show');
    } else{
      if(document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper .selected').classList.contains('continue')){
        document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper').classList.add("hide");
        document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper').classList.remove("hide")
      } else{
        document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper').classList.add("hide");
  ...
  document.querySelector('.spz-2002 #popup_request_a_demo .step-wrapper .next-2').addEventListener("click",function(){
    if(!(document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper .selected'))){
      document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper .error-message').classList.add('show');
    } else{
      document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper').classList.add("hide");
      document.querySelector('.spz-2002 #new-formDemo-wrapper').classList.add("show")
    }
  })
  document.querySelector('.spz-2002 #popup_request_a_demo .step1-wrapper').addEventListener("click",function(e){
  ...
  document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper').addEventListener("click",function(e){
    if(e.target.closest('.option') && !e.target.closest('.option').classList.contains('selected')){
      if(document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper .selected')){
        document.querySelector('.spz-2002 #popup_request_a_demo .step2-wrapper .selected').classList.remove('selected')
      }
