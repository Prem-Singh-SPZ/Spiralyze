const bodyInterval = setInterval(function () {
    if (document.querySelector('body')) {
        ...
        const allDemoCTA = document.querySelector('a#request-demo') || document.querySelector('a[href="#popup_request_a_demo"]') || document.querySelector('a[href="https://www.komodohealth.com/get-demo"]') || document.querySelector('a[href="#tmpwidget_1665168603900"]');
