...
const heroImages = {
    tab1: {
        desk: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_1443.webp',
        tab: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background.webp',
        mob: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_368.webp'
    },
    tab2: {
        desk: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_1441.webp',
        tab: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_769.webp',
        mob: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_365.webp'
    },
    tab3: {
        desk: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_1444.webp',
        tab: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_770.webp',
        mob: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_366.webp'
    },
    tab4: {
        desk: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_1440.webp',
        tab: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_768.webp',
        mob: '//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/hero_background_364.webp'
    },
};
...
const bodyInterval = setInterval(function () {
    if (document.querySelector('body')) {
        ...
        // ##############################  
        // THIS MAY HAVE TO DELETE IN HARDCODE STARTS
        //set CRO 
        /*function setValue(anomaly = false) {
            ...
            if (anomaly == "anomaly1" || anomaly == "normal") {
                iframe.querySelector('input[name="cro2"]').value = "3001_variant";
            }
            else {
                var iframeContent = iframe.contentWindow;
                iframeContent.document.querySelector('input[name="cro2"]').value = "3001_variant";
            }
        }
        ...
        <div class="slider1-wrapper">
            ...
            <ul class="splide__list">
                ...
                <div class="child child3">
                    <div class="picture">
                    <picture>
                        <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/joey_mattingly_360.webp">
                        <source media="(max-width:1079.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/joey_mattingly_768.webp">
                        <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/personjoey.webp" alt="Joey Mattingly" class="ts-img"/>
                    </picture>
                    </div>
                    <div class="text">
                    ...
                    <div class="user-info">
                        ...
                        <picture>
                            <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/komodohealth/5001/maryland_mobile.svg">
                            <img class="icon" alt="University of Maryland" src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/komodohealth/5001/maryland_desktop.svg" width="112" height="48" />
                        </picture>
                    </div>
                    </div>
                </div>
                ...
                <div class="child child2">
                    <div class="picture">
                    <picture>
                        <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/michael_townsend_360.webp">
                        <source media="(max-width:1079.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/michael_townsend_768.webp">
                        <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/personmichael.webp" alt="Michael Townsend" class="ts-img"/>
                    </picture>
                    </div>
                    <div class="text">
                    ...
                    <div class="user-info">
                        ...
                        <picture>
                            <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/komodohealth/5001/idc_mobile.svg">
                            <img class="icon" src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/komodohealth/5001/idc_desktop.svg" alt="International Data Corporation" width="112" height="48" />
                        </picture>
                    </div>
                    </div>
                </div>
                ...
                <div class="child child1">
                    <div class="picture">
                    <picture>
                        <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/tom_haskell_360.webp">
                        <source media="(max-width:1079.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/tom_haskell_768.webp">
                        <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/persontom.webp" alt="Tom Haskell" class="ts-img"/>
                    </picture>
                    </div>
                    <div class="text">
                    ...
                    <div class="user-info">
                        ...
                        <picture>
                            <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/KomodoHealth/3008/kantar_logo.svg">
                            <img class="icon" src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/KomodoHealth/3008/kantar_logo.svg" alt="Kantar" width="112" height="48" />
                        </picture>
                    </div>
                    </div>
                </div>
                ...
                <div class="tabs-content">
                    <div class="us-container">
                        <div class="us-tab active" data-index="1">
                            ...
                            <div class="content">
                                <div class="text">
                                    <p>View patient journeys, from first visit to diagnosis and treatment pathways. Create
                                        complex
                                        cohorts in minutes. Get alerts for new patients near trial sites.</p>
                                    <p>Identify eligible patients, principal investigators, and trial sites. Accelerate
                                        recruitment
                                        and increase trial diversity.</p>
                                </div>
                                <picture>
                        ...
                        <div class="us-tab" data-index="2">
                            ...
                            <div class="content">
                                <div class="text">
                                    <p>Generate strategic launch insights quickly with real-time provider and patient volumes,
                                        patient journeys, payer analytics, targeting, and brand performance.</p>
                        ...
                        <div class="us-tab" data-index="3">
                            ...
                            <div class="content">
                                <div class="text">
                                    <p>Analyze treatment patterns of specific patient populations to identify unmet needs,
                                        understand adherence, healthcare utilization, and real-world efficacy.</p>
                                    <p>Demonstrate your therapy's value, assess cost-effectiveness, and build clinical and
                                        economic
                                        comparisons to influence policy and formulary decisions</p>
                                    <p>Leverage high-fidelity patient-level data to develop safety studies for post-launch
                                        monitoring and surveillance.</p>
                        ...
                        <div class="us-tab" data-index="4">
                            ...
                            <div class="content">
                                <div class="text">
                                    <p>Understand patient journey, provider clinical behavior, and unmet needs to inform medical
                                        strategies. Compliantly measure clinical outcomes to articulate the value of activities.
                                    </p>
                                    <p>Visualize HCP dynamics/referral patterns, and generate effective field engagement
                                        strategies.
                                    </p>
                                    <p>Offer omnichannel engagement to address medical inquiries quickly, then track clinical
                                        interactions to identify knowledge gaps.</p>
                                    <p>Seamlessly manage collaboration around the sponsorship, generation, and publication of
                                        scientific data.</p>
                                </div>
                                <picture>
                                    <source media="(max-width:767.98px)"
        ...
        <div class="resources-sec-spz">
            <div class="wrapper">
                ...
                <div class="cards">
                    <div class="card">
                        <picture>
                            <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/card_1_360.webp">
                            <source media="(max-width:1079.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/card_5.webp">
                            <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/card_1.webp" alt="Perspectives" class="card-img">
                        </picture>
                        <div class="card-content">
                            <div class="tag">PERSPECTIVES</div>
                            <div class="title">Taking the Long-Term View To Leverage the Power of AI in Healthcare Today</div>
                            <div class="description">Komodo’s Co-Founder and CEO, Dr. Arif Nathoo, sat down with Sid Jain from Johnson & Johnson to discuss the future of healthcare.</div>
                            <a href="https://www.komodohealth.com/perspectives/taking-the-long-term-view-to-leverage-the-power-of-ai-in-healthcare-today" rel="modal:open" class="cta">
                    ...
                    <div class="card">
                        <picture>
                            <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/card_2_360.webp">
                            <source media="(max-width:1079.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/card_4.webp">
                            <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/card_2.webp" alt="Perspectives" class="card-img">
                        </picture>
                        <div class="card-content">
                            <div class="tag">PERSPECTIVES</div>
                            <div class="title">One Day, We Will Have Layered Datasets for High-Nuance, High-Impact...</div>
                            <div class="description">Komodo’s The One Day Summit hosted a conversation for HEOR teams about integrating multiple data sources to support...</div>
                            <a href="https://www.komodohealth.com/perspectives/one-day-we-will-have-layered-datasets-for-high-nuance-high-impact-outcomes-research" rel="modal:open" class="cta">
                                <span>Learn More</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <picture>
                            <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/card_3_360.webp">
                            <source media="(max-width:1079.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/ui.webp">
                            <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/komodohealth/3008/card_3.webp" alt="Perspectives" class="card-img">
                        </picture>
                        <div class="card-content">
                            <div class="tag">PERSPECTIVES</div>
                            <div class="title">One Day, Clinical Trials Will Represent the Real World</div>
                            <div class="description">Hear from Clinical Development leaders at Komodo’s One Day Summit discussing the impact RWE will have on clinical trial strategy.</div>
                            <a href="https://www.komodohealth.com/perspectives/one-day-clinical-trials-will-represent-the-real-world" rel="modal:open" class="cta">
                                <span>Learn More</span>
                            </a>
                        </div>
                    </div>
