...
ready(function () {
  ...
  if (!document.querySelector('.spz-15001')) {
    ...
    if (window.location.href.indexOf('/demos') > -1) {
      ...
      document.querySelector('body #main-content .dnd_area-row-1-background-layers').insertAdjacentHTML('beforebegin', `<div class="spz-demos-listing"><div class="spz-container"><div class="demos-listing-row"></div></div></div>`);
