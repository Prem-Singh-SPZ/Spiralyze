    ...
    if (!document.querySelector('.spz-8004')) {
        ...
        waitForElm('#main-content .dnd_area-row-0-hidden > .row-fluid > .span12 .row-number-4 .widget-span').then(() => {
            if (document.querySelectorAll('.spz-hero-copy-wrapper').length == 0) {
                ...
                document.querySelector('#main-content .dnd_area-row-0-hidden > .row-fluid > .span12 .row-number-4 .widget-span').insertAdjacentHTML('beforeend', `<div class="spz-hero-copy-wrapper tab-mob"><div class="bullet-container"><ul class="bullet-wrapper"><li class="bullet-item"><span>MapAI™.</span> Use natural language to generate actionable insights with MapAI™</li><li class="bullet-item"><span>MapExplorer™.</span>  Easily explore patient-centric data using MapExplorer™</li><li class="bullet-item"><span>MapView™.</span>  Accelerate data analytics with MapView™ and customizable dashboards</li></ul></div><div class="spz-btn-wrapper"><a class="spz-btn" href="#tmpwidget_1721318819360" rel="modal:open">REQUEST A CUSTOM DEMO</a></div></div>`);
