(function () {
            ...
            if (body) {
                ...
                if (!body.classList.contains('SPZ-1008-TC')) {
                    ...
                    function formModify() {
                        ...
                        // document.querySelector('.SPZ-1008-TC form.mktoForm #contactFormComments.mktoField').value = 'Get a demo';
                        ...
                        function focusFields() {
                            ...
                            form.addEventListener('focus', function (event) {
                                ...
                                var email_field = document.querySelector('.SPZ-1008-TC .spz-form-section form.mktoForm input[name="Email"]');
    ...
    function checkEmail() {
        const emailField = document.querySelector('.SPZ-1008-TC .spz-form-section form.mktoForm input[name="Email"]');
