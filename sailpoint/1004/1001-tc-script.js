...
.spz_1004_tc .announcement-banner,
.spz_1004_tc nav.navigation,
.spz_1004_tc .page-transition,
.spz_1004_tc footer .container.grid {
  display: none;
}

.spz_1004_tc #__next .font-sans>.flex-col {
  position: relative;
}

.spz_1004_tc .spz-hero {
  position: relative;
  padding: 64px 0 81px;
  margin-bottom: 82px;
  overflow: hidden;
...
.spz_1004_tc.form-expand .spz-hero::after {
  bottom: 193px;
}

.spz_1004_tc .spz-hero .spz-wrapper {
  width: 100%;
  max-width: 1330px;
  padding: 0 20px;
  margin: 0 auto;
...
.spz_1004_tc .spz-hero .spz-form-wrap {
  display: flex;
  flex-wrap: wrap;
...
.spz_1004_tc.form-submit .spz-hero .spz-form-wrap {
  align-items: center;
}

.spz_1004_tc .spz-hero .spz-form-wrap .content-section {
  width: 49.77%;
  max-width: 642px;
}

.spz_1004_tc .spz-hero .spz-form-wrap .spz-form-section {
  width: 46.52%;
  max-width: 600px;
}

.spz_1004_tc .spz-hero .spz-form-wrap .spz-form-section .the-form {
  width: 100%;
  min-height: auto;
}

.spz_1004_tc .spz-form-wrap .site-logo {
  display: inline-flex;
  flex-wrap: wrap;
  width: auto;
  height: auto;
...
.spz_1004_tc .spz-form-wrap .site-logo img {
  width: 100%;
  max-width: 150px;
  height: auto;
}

.spz_1004_tc .spz-form-wrap .content-superheading {
  color: #415364;
  font-size: 14px;
  font-style: normal;
  font-weight: 600;
...
.spz_1004_tc .spz-form-wrap .content-heading {
  color: #0033A1;
  font-size: 50px;
  font-style: normal;
  font-weight: 600;
...
.spz_1004_tc .spz-form-wrap .spz-features-wrap {
  display: flex;
  flex-wrap: wrap;
  margin-top: 32px;
  position: relative;
...
.spz_1004_tc .spz-form-wrap .spz-features-wrap .feature-item {
  display: flex;
  flex-wrap: wrap;
  margin-bottom: 29px;
  padding-left: 36px;
...
.spz_1004_tc .spz-form-wrap .spz-features-wrap .feature-item:last-child {
  margin: 0;
}

.spz_1004_tc .spz-form-wrap .spz-features-wrap img {
  position: absolute;
  width: 24px;
  height: 24px;
  top: -1px;
...
.spz_1004_tc .spz-form-wrap .spz-features-wrap span {
  color: #415364;
  font-size: 16px;
  font-style: normal;
  font-weight: 400;
...
.spz_1004_tc .spz-form-wrap .spz-features-wrap span b {
  font-weight: 600;
}

.spz_1004_tc .spz-form-wrap .form-arrow {
...
.spz_1004_tc.form-expand .spz-form-wrap .form-arrow {
...
.spz_1004_tc .spz-form-section .form-heading {
  color: #415364;
  font-size: 30px;
  font-style: normal;
  font-weight: 600;
...
.spz_1004_tc.form-submit .spz-form-section .form-heading,
.spz_1004_tc .contact_us_submit_spz {
  display: none;
}

.spz_1004_tc.form-submit .contact_us_submit_spz {
  display: flex;
  flex-direction: column;
}

.spz_1004_tc .spz-hero .social-proof-logos {
  margin-top: 57px;
  width: 100%;
  max-width: 1330px;
  padding: 0 20px;
...
.spz_1004_tc.form-expand .spz-hero .social-proof-logos {
  margin: 64px auto 0;
}

.spz_1004_tc .spz-hero .social-proof-logos .social-proof-heading {
  color: #415364;
  text-align: center;
  font-size: 21px;
  font-style: normal;
...
.spz_1004_tc .spz-hero .social-proof-logos .social-proof-images {
  display: flex;
  flex-wrap: wrap;
  align-items: center;
  justify-content: space-between;
...
.spz_1004_tc .social-proof-logos .social-proof-images img {
  width: auto;
  height: 58px;
  object-fit: contain;
}

.spz_1004_tc .social-proof-logos .social-proof-images img.repeat-img {
  display: none;
}
...
.spz_1004_tc footer .container.flex {
  border: none;
  width: 100%;
  max-width: 1330px;
  padding: 0 20px;
...
.spz_1004_tc footer .container.flex p {
  margin-block: 0;
}
...
@media(max-width: 1023.98px) {
  ...
  .spz_1004_tc.form-submit .spz-hero .spz-form-wrap .spz-form-section {
    align-items: center;
    display: flex;
  }
  ...
  .spz_1004_tc .spz-hero .social-proof-logos::before,
  .spz_1004_tc .spz-hero .social-proof-logos::after {
    position: absolute;
    content: "";
    width: 122px;
    height: 60px;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoOffset,
.spz_1004_tc .spz-form-section form.mktoForm .mktoClear,
.spz_1004_tc .spz-form-section form.mktoForm .mktoGutter {
  display: none !important;
}

.spz_1004_tc .spz-form-section form.mktoForm {
  display: flex;
  flex-wrap: wrap;
  justify-content: space-between;
  width: 100% !important;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFormRow,
.spz_1004_tc .spz-form-section form.mktoForm #captcha {
  width: 100%;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFormRow.placeholder-row:not(.field-10) {
  display: none;
}
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap {
  position: relative;
  width: 100%;
  display: flex;
  flex-flow: column;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap label.mktoLabel {
  color: #415364;
  font-size: 14px;
  font-style: normal;
  font-weight: 400;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap label.mktoLabel#LblreceivingAdvertisingInformation,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap label.mktoLabel#LblmandatoryCollectionandUseofPersonalInfo,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap label.mktoLabel#LbloptionalCollectionandUseofInformation {
  position: relative;
  top: unset;
  left: unset;
  padding: 0;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap>label#LblGlobal_Opt_out__c,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap>label#LblGlobal_Opt_in__c,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap>label#LblcCPAAgeVerification {
  display: none;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap label.mktoLabel .mktoAsterix {
  display: none !important;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap:hover label.mktoLabel,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap:hover label.mktoLabel .mktoAsterix {
  color: #415364;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.filled:not(.active):not(.error) label.mktoLabel,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.filled:not(.active):not(.error) label.mktoLabel .mktoAsterix {
  color: #415364 !important;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.active.typing label.mktoLabel,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.filled label.mktoLabel {
  width: auto !important;
  top: -12px;
  color: #0071CE;
  font-size: 12px;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.active.typing label.mktoLabel .mktoAsterix,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.active.typing label.mktoLabel .mktoAsterix {
  color: #0071CE;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.error label.mktoLabel,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.error label.mktoLabel .mktoAsterix {
  color: #E6241E;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoField:not([type=checkbox]) {
  width: 100% !important;
  height: 50px;
  display: flex;
  flex-wrap: wrap;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap:not(.active):not(.typing):not(.filled) select.mktoField {
  color: transparent !important;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap select.mktoField {
  padding-right: 37px !important;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap:hover .mktoField:not([type="checkbox"]) {
  border-color: #415364;
}

.spz_1004_tc:not(.form-expand) .spz-form-section form.mktoForm .mktoFieldWrap.emailerror .mktoField:not([type="checkbox"]),
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.error .mktoField:not([type="checkbox"]) {
  border-color: #E6241E;
  box-shadow: none;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap.active.typing .mktoField:not([type="checkbox"]) {
  border-color: #0071CE;
  box-shadow: inset 0 0 0 1px #0071CE;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoError,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoError_1 {
  position: relative;
  top: unset !important;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoError .mktoErrorMsg,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoError_1 .mktoErrorMsg {
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoError .mktoErrorMsg::before,
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoError_1 .mktoErrorMsg::before {
  position: absolute;
  content: "";
  width: 12px;
  height: 12px;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .select-wrapper {
  margin: 0 !important;
  width: 100%;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .select-wrapper::after {
  position: absolute;
  content: "";
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .select-wrapper .select-dropdown {
  display: none;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoError .mktoErrorArrowWrap {
  display: none !important;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoCheckboxList {
  margin-bottom: 0;
  padding: 0;
  width: auto !important;
  display: flex;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoCheckboxList input,
.spz_1004_tc .spz-form-section form.mktoForm input[type="checkbox"] {
  min-width: 16px;
  width: 16px;
  height: 16px;
  position: relative;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoButtonRow {
  width: 100%;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoButtonRow .mktoButtonWrap {
  margin: 0 !important;
}

.spz_1004_tc .spz-form-section form.mktoForm .mktoButtonRow .mktoButton {
  width: 100%;
  height: 48px;
  display: flex;
  flex-wrap: wrap;
...
.spz_1004_tc .spz-form-section form.mktoForm .mktoButtonRow .mktoButton:hover {
  background: #005DAA;
}
...
.spz_1004_tc.form-expand .spz-form-section .disclaimer {
  margin-top: 8px;
}

.spz_1004_tc.form-submit .spz-form-section .disclaimer {
  display: none;
}
...
@media(max-width: 767.98px) {
  ...
  .spz_1004_tc .spz-form-section form.mktoForm .mktoCaptchaDisclaimer a {
    display: inline-block;
    padding: 0;
  }
}
...
(function () {
    ...
    let bodyLoaded = setInterval(function () {
      ...
      if (body) {
        ...
        if (!body.classList.contains('spz_1004_tc')) {
          body.classList.add('spz_1004_tc');
          ...
          function addBaseline(formData, whereToPut, formSelector, heroSelector, additionalSection) {
            ...
            let formLoaded = setInterval(() => {
              if (document.querySelector(".spz_1004_tc .spz-form-wrap .the-form") && document.querySelector(formSelector) && document.querySelectorAll(`${formSelector} input`).length > 0) {
                clearInterval(formLoaded)
                document.querySelector(".spz_1004_tc .spz-form-wrap .the-form").appendChild(document.querySelector(formSelector));
                waitForElm('.spz_1004_tc .mkto-wrap + .disclaimer').then(() => {
                  document.querySelector(".spz_1004_tc .spz-form-wrap .the-form").insertAdjacentElement('afterend', document.querySelector('.spz_1004_tc .mkto-wrap + .disclaimer'));
                });
                formModify();
          ...
          function formModify() {
            var form_fields = document.querySelectorAll('.spz_1004_tc .spz-form-section form.mktoForm .mktoFormRow');
            ...
            ['#LblCountry:Country', '#LblState:State', '#LblNumber_of_Employees__c:Number of employees'].forEach(item => {
              ...
              waitForElm(`.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap label.mktoLabel${id}`).then(label => {
            ...
            waitForElm(`.spz_1004_tc .spz-form-section form.mktoForm .mktoFieldWrap select#Country`).then((elm) => {
              setTimeout(() => {
                document.querySelectorAll(`.spz_1004_tc form.mktoForm .mktoFormCol .mktoFieldWrap .mktoField`).forEach(function (el) {
            ...
            function focusFields() {
              const form = document.querySelector('.spz_1004_tc form.mktoForm');
              ...
              form.addEventListener('focus', function (event) {
                ...
                var email_field = document.querySelector('.spz_1004_tc .spz-form-section form.mktoForm input[name="Email"]');
              ...
              function reapplyStateFieldListeners() {
                const stateField = document.querySelector('.spz_1004_tc form.mktoForm .mktoFieldWrap .mktoField#State');
                if (stateField) {
              ...
              const container = document.querySelector('.spz_1004_tc form.mktoForm');
              if (container) {
            ...
            function checkAllFields() {
              const fields = document.querySelectorAll('.spz_1004_tc form.mktoForm .mktoField');
  ...
  function removeTest() {
    setTimeout(() => {
      if (document.querySelector('.spz_1004_tc')) {
        document.body.classList.remove("spz_1004_tc");
      }
  ...
  function checkEmail() {
    const emailField = document.querySelector('.spz_1004_tc .spz-form-section form.mktoForm input[name="Email"]');
    const emailRegex = /^[^\s@]+@[a-zA-Z0-9]+(?:\.[a-zA-Z0-9-]+)*\.[a-zA-Z]{2,}$/;
    if (emailField) {
