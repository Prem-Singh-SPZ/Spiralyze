        ...
        if (!body.classList.contains('SPZ-1005-TC')) {
          ...
          function addBaseline(formData, whereToPut, formSelector, heroSelector, additionalSection) {
            ...
            let formLoaded = setInterval(() => {
              if (document.querySelector(".SPZ-1005-TC .spz-form-wrap .the-form") && document.querySelector(formSelector) && document.querySelectorAll(`${formSelector} input`).length > 0) {
                clearInterval(formLoaded)
                document.querySelector(".SPZ-1005-TC .spz-form-wrap .the-form").appendChild(document.querySelector(formSelector));
                waitForElm('.SPZ-1005-TC .mkto-wrap + .disclaimer').then(() => {
                  document.querySelector(".SPZ-1005-TC .spz-form-wrap .the-form")?.appendChild(document.querySelector('.SPZ-1005-TC .mkto-wrap + .disclaimer')?.cloneNode(true));
                });
