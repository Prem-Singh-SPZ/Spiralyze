(function () {
	...
	function urlCheck(url) {
		if (urls.indexOf(window.location.href.split('?')[0]) >= 0) {
			...
			if (document.querySelector('body').classList.contains('spz_2009_v2')) {
				document.querySelector('body').classList.remove('spz_2009_v2');
			}
			if (document.querySelector('body').classList.contains('spz_2009_HF_v2')) {
				document.querySelector('body').classList.remove('spz_2009_HF_v2');
			}
			removeSpecificCookieValue('spz_2009', 'SPZ_2009_variant2');
		}
	}
			...
			if (body) {
				...
				if (window.location.pathname === "/") {
					...
					waitForElm('.hero.hero--homepage .hero__buttons .btn.btn--blue-alt').then((elm) => {
						...
						const button = document.querySelector('.hero.hero--homepage .hero__buttons .btn.btn--arrow-alt');
						button.childNodes[0].nodeValue = "Talk to an expert";
						if (button) {
					...
					if (!body.classList.contains('spz_2009_v2')) {
						body.classList.add('spz_2009_v2');
					} else {
						if (body.classList.contains('spz_2009_v2')) {
							hiddenValue('spz_2009', 'SPZ_2009_variant2');
						}
					...
					document.body.classList.add('spz_2009_HF_v2');
