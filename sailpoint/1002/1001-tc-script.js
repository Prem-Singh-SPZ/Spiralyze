// #1001
var css = `.spz_1002_tc .announcement-banner,
.spz_1002_tc nav.navigation,
.spz_1002_tc .page-transition,
.spz_1002_tc footer .container.grid {
    display: none;
}

.spz_1002_tc #__next .font-sans>.flex-col {
    position: relative;
}

.spz_1002_tc .spz-hero {
    position: relative;
    padding: 64px 0 81px;
    margin-bottom: 82px;
    overflow: hidden;
...
.spz_1002_tc .spz-hero::before {
    position: absolute;
    content: "";
    background-image: url("//res.cloudinary.com/spiralyze/image/upload/f_auto/sailpoint/1001/illustrator.webp");
...
.spz_1002_tc .spz-hero .spz-wrapper {
    width: 100%;
    max-width: 1328px;
    padding: 0 20px;
    margin: 0 auto;
...
.spz_1002_tc .spz-hero .spz-form-wrap {
    display: flex;
    flex-wrap: wrap;
...
.spz_1002_tc.form-submit .spz-hero .spz-form-wrap {
    align-items: center;
}

.spz_1002_tc .spz-hero .spz-form-wrap .content-section,
.spz_1002_tc .spz-hero .spz-form-wrap .spz-form-section {
    width: 48.08%;
    max-width: 600px;
}
...
.spz_1002_tc .spz-form-wrap .site-logo {
    display: inline-flex;
    flex-wrap: wrap;
    width: auto;
    height: auto;
...
.spz_1002_tc .spz-form-wrap .site-logo img {
    width: 100%;
    max-width: 150px;
    height: auto;
}

.spz_1002_tc .spz-form-wrap .content-superheading {
    color: #415364;
    font-size: 14px;
    font-style: normal;
    font-weight: 600;
...
.spz_1002_tc .spz-form-wrap .content-heading {
    color: #0033A1;
    font-size: 50px;
    font-style: normal;
    font-weight: 600;
...
.spz_1002_tc .spz-form-wrap .spz-features-wrap {
    display: flex;
    flex-wrap: wrap;
    margin-top: 32px;
    position: relative;
...
.spz_1002_tc .spz-form-wrap .spz-features-wrap .feature-item {
    display: flex;
    flex-wrap: wrap;
    margin-bottom: 29px;
    padding-left: 36px;
...
.spz_1002_tc .spz-form-wrap .spz-features-wrap .feature-item:last-child {
    margin: 0;
}

.spz_1002_tc .spz-form-wrap .spz-features-wrap img {
    position: absolute;
    width: 24px;
    height: 24px;
    top: -1px;
...
.spz_1002_tc .spz-form-wrap .spz-features-wrap span {
    color: #415364;
    font-size: 16px;
    font-style: normal;
    font-weight: 400;
...
.spz_1002_tc .spz-form-wrap .spz-features-wrap span b {
    font-weight: 600;
}

.spz_1002_tc .spz-form-wrap .form-arrow {
    margin: 45px 44px 0px auto;
    width: 176.83px;
    height: 116px;
    object-fit: contain;
}
...
.spz_1002_tc .spz-form-section .form-heading {
    color: #415364;
    font-size: 30px;
    font-style: normal;
    font-weight: 600;
...
.spz_1002_tc.form-submit .spz-form-section .form-heading {
    display: none;
}

.spz_1002_tc .spz-hero .social-proof-logos {
    margin-top: 57px;
    width: 100%;
    max-width: 1328px;
    padding: 0 20px;
...
.spz_1002_tc .spz-hero .social-proof-logos .social-proof-heading {
    color: #415364;
    text-align: center;
    font-size: 21px;
    font-style: normal;
...
.spz_1002_tc .spz-hero .social-proof-logos .social-proof-images {
    display: flex;
    flex-wrap: wrap;
    align-items: center;
    justify-content: space-between;
...
.spz_1002_tc .social-proof-logos .social-proof-images img {
    width: auto;
    height: 58px;
    object-fit: contain;
}

.spz_1002_tc .social-proof-logos .social-proof-images img.repeat-img {
    display: none;
}
...
.spz_1002_tc footer .container.flex {
    border: none;
    width: 100%;
    max-width: 1328px;
    padding: 0 20px;
...
@media(max-width: 1023.98px) {
    ...
    .spz_1002_tc .spz-hero .social-proof-logos::before,
    .spz_1002_tc .spz-hero .social-proof-logos::after {
        position: absolute;
        content: "";
        width: 122px;
        height: 60px;
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-3,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-4,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-5,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-6,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-7,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-8.spz-half,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-9,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-10 {
    width: calc(50% - 8px);
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-11,
.spz_1002_tc .spz-form-section form.mktoForm>div:not([class]):not([id]) {
    display: none;
}
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap:hover label.mktoLabel,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap:hover label.mktoLabel .mktoAsterix {
    color: #415364;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.filled:not(.active):not(.error) label.mktoLabel,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.filled:not(.active):not(.error) label.mktoLabel .mktoAsterix {
    color: #415364 !important;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.active.typing label.mktoLabel,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.filled label.mktoLabel {
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.active.typing label.mktoLabel .mktoAsterix,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.active.typing label.mktoLabel .mktoAsterix {
    color: #0071CE;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.error label.mktoLabel,
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.error label.mktoLabel .mktoAsterix {
    color: #E6241E;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoField:not([type=checkbox]) {
    width: 100% !important;
    height: 50px;
    display: flex;
    flex-wrap: wrap;
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap select.mktoField {
    padding-right: 37px !important;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap:hover .mktoField:not([type="checkbox"]) {
    border-color: #415364;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.active.typing .mktoField:not([type="checkbox"]) {
    border-color: #0071CE;
    box-shadow: 0 0 0 1px #0071CE;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap.error .mktoField:not([type="checkbox"]) {
    border-color: #E6241E;
    box-shadow: none;
}
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap .select-wrapper
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap .select-wrapper .select-dropdown {
    display: none;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap .mktoError .mktoErrorArrowWrap
/* ,.spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList input[type=checkbox]  */
{
    display: none !important;
}

/* .spz_1002_tc .mktoForm input[type=checkbox] {
    width: 16px;
    height: 16px;
    margin: 0;
}  */
...
/* .spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList~input[type=checkbox] {
 ...
 @media (max-width: 767.98px) {
    /* .spz_1002_tc .mktoCheckboxList input[type=checkbox] {
        width: 20px;
        height: 20px;
    } */
...
.spz_1002_tc .spz-form-section form.mktoForm .field-31 .mktoFieldWrap {
  margin-bottom: 10px;
}
  .spz_1002_tc .spz-form-section form.mktoForm .field-31 .mktoCheckboxList {
   margin-bottom: 0;
  }

.spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList label {
    position: relative;
    color: #415364;
    font-size: 12px;
    font-style: normal;
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList label:hover::before {
    border-color: #0071CE;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList input:checked+label:before {
    border: none;
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList input:checked+label:hover:before {
    background-image: url("//res.cloudinary.com/spiralyze/image/upload/f_auto/sailpoint/1001/checkboxes-hover.png");
} */

/* .spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList label::after {
    position: absolute;
    content: "";
    width: 32px;
    height: 32px;
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList label:active::after {
    background: #415364;
    opacity: 0.1;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList label:focus::after {
    background: #415364;
    opacity: 0.3;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList input:checked+label:active::after {
    background: #0071CE;
    opacity: 0.1;
} */

/* .spz_1002_tc .spz-form-section form.mktoForm .mktoCheckboxList input:checked+label:focus::after {
    background: #0071CE;
    opacity: 0.3;
} */

.spz_1002_tc .spz-form-section form.mktoForm .mktoButtonRow {
    width: 100%;
    margin-top: 6px;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoButtonRow .mktoButton {
    width: 100%;
    height: 48px;
    display: flex;
    flex-wrap: wrap;
...
.spz_1002_tc .spz-form-section form.mktoForm .mktoButtonRow .mktoButton:hover {
    background: #005DAA;
}

.spz_1002_tc .spz-form-section form.mktoForm .mktoCaptchaDisclaimer,
.spz_1002_tc .spz-form-section .disclaimer {
    margin: 6px auto 0;
    padding: 0;
    color: #415364;
    font-size: 12px;
...
(function () {
  function createTest() {
    let bodyLoaded = setInterval(function () {
      ...
      if (body) {
        ...
        if (!body.classList.contains('spz_1002_tc')) {
          body.classList.add('spz_1002_tc');
          ...
          let spzHeroInterval = setInterval(() => {
            if (document.querySelectorAll('.spz-hero').length == 0 && window.location.pathname === '/demo') {
              ...
              hiddenValue('spz-1002', 'SPZ_1002_truecontrol');
              setHiddenFieldValue();
            }
            else {
          ...
          function formModify() {
            ...
            var form_fields = document.querySelectorAll('.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow');
            ...
            ['#LblCountry:Country', '#LblState:State', '#LblNumber_of_Employees__c:Number of employees'].forEach(item => {
              ...
              waitForElm(`.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap label.mktoLabel${id}`).then(label => {
                label.innerHTML = (label.querySelector('.mktoAsterix')?.outerHTML || '') + text;
              });
            });

            waitForElm('.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-31 .mktoCheckboxList label').then(label => {
              label.textContent = "Uncheck the box to discontinue receiving email communications from SailPoint.";
            });

            // Change Field Position
            var employees_field = document.querySelector('.spz_1002_tc form.mktoForm .field-8');
            var state_field = document.querySelector('.spz_1002_tc form.mktoForm .field-10');
            state_field.after(employees_field);

            // var disclaimer_field = document.querySelector('.spz_1002_tc form.mktoForm .mktoCaptchaDisclaimer');
            // var button = document.querySelector('.spz_1002_tc form.mktoForm .mktoButtonRow');
            // button.after(disclaimer_field);

            document.querySelector('.spz_1002_tc form.mktoForm .field-11 .mktoField').value = 'Get live demo';

            waitForElm(`.spz_1002_tc .spz-form-section form.mktoForm .mktoFieldWrap select#Country`).then((elm) => {
              setTimeout(() => {
                document.querySelectorAll(`.spz_1002_tc form.mktoForm .mktoFormCol .mktoFieldWrap .mktoField`).forEach(function (el) {
            ...
            function focusFields() {
              ...
              const form = document.querySelector('.spz_1002_tc form.mktoForm');
              ...
              function reapplyStateFieldListeners() {
                const stateField = document.querySelector('.spz_1002_tc form.mktoForm .mktoFieldWrap .mktoField#State');
                if (stateField) {
              ...
              const container = document.querySelector('.spz_1002_tc form.mktoForm');
              if (container) {
            ...
            document.querySelector('select#Country').addEventListener('change', () => {
              ...
              const optOutRow = document.querySelector('.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-31');
              const employeeNumberRow = document.querySelector('.spz_1002_tc .spz-form-section form.mktoForm .mktoFormRow.field-8');
  ...
  function removeTest() {
    setTimeout(() => {
      if (document.querySelector('.spz_1002_tc')) {
        document.body.classList.remove("spz_1002_tc");
      }
    }, 2000);
  }
