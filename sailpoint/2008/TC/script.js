	...
	function urlCheck(url) {
		if (urls.indexOf(window.location.href.split('?')[0]) >= 0) {
			...
			if (document.querySelector('body').classList.contains('SPZ_2008_tc')) {
				document.querySelector('body').classList.remove('SPZ_2008_tc');
			}
			if (document.querySelector('body').classList.contains('spz_2008_tc_HF')) {
				document.querySelector('body').classList.remove('spz_2008_tc_HF');
			}
	...
	function initTC() {
		let bodyLoaded = setInterval(function () {
			...
			if (body && window.location.pathname === "/") {
				...
				if (!body.classList.contains('SPZ_2008_tc')) {
					body.classList.add('SPZ_2008_tc');
					hiddenValue('SPZ_2008', 'SPZ_2008_truecontrol');
				}
			}
			else {
				clearInterval(bodyLoaded);
				document.body.classList.add('spz_2008_tc_HF');
