(function () {
    function createTest() {
        let bodyLoaded = setInterval(function () {
            ...
            if (body) {
                ...
                if (!body.classList.contains('SPZ_7001-TC')) {
                    removeSpecificCookieValue('SPZ_7001', 'SPZ_7001_Variant');
                    body.classList.add('SPZ_7001-TC');
                    hiddenValue('SPZ_7001', 'SPZ_7001_truecontrol');
                    setHiddenFieldValue();
                }
                else {
                    if (body.classList.contains('SPZ_7001-TC')) {
    ...
    function removeTest() {
        setTimeout(() => {
            if (document.querySelector('.SPZ_7001-TC')) {
                document.body.classList.remove("SPZ_7001-TC");
            }
        }, 2000);
    }
