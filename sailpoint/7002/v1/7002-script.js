(function () {
    ...
    document.addEventListener('click', function (e) {
        ...
        if (e.target.closest('.mktoButton')) {
            ...
            if (document.querySelector('.spz_7002_v1 #mktoForm_1017.mktoForm input[name="intellimize2"]'))
                document.querySelector('.spz_7002_v1 #mktoForm_1017.mktoForm input[name="intellimize2"]').value = n;
        }
    });
