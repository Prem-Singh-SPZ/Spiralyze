...
body.spz-8001 #page-container .page-transition main #contact-us .row__inner > .column:last-child .column__inner .mkto-wrap .mktoForm .mktoFormRow .mktoFieldWrap .mktoError .mktoErrorMsg::before {
  position: absolute;
  content: "";
  width: 12px;
  height: 12px;
  top: 3px;
  left: 0;
  background-image: url(//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/sailpoint/1001/error-icon.svg);
