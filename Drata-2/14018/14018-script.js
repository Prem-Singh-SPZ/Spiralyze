(function () {
    ...
    function complianceChanges_V1() {
        document.querySelector('.simple-steps-sec-14018').insertAdjacentHTML('afterend', `<section class="compliance-sec spz-sec">
