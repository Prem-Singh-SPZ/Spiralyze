(function () {
    ...
    function createTest() {
        ...
        waitForElm('header + div[data-csk-entry-type="hero"] > .MuiContainer-root').then(function () {
            document.querySelector("body").classList.add("spz-14007-tc");
        ...
        createCookie('spz-14007-tc-loaded', 'true', 1);
    }

    function removeTest() {
        document.body.classList.remove("loaded-test");
        document.body.classList.remove("spz-14007-tc");
    ...
    function demoChecked() {
        const sInt = setInterval(() => {
            ...
            // Check if spz-14007-tc-loaded cookie is present and cro_field is present
            if ((cro_field && cro_field.val != '') && isCookieExist('spz-14007-tc-loaded')) {
                clearInterval(sInt);
                submitTestDetails('Control_14007');

                // deleteCookie('spz-14007-tc-loaded');
            }
        }, 1000);
    ...
    function videoIntegration() {
        ...
        window.addEventListener('scroll', function () {
            ...
            if (!document.querySelector('.spz-14007-tc')) {
                window.removeEventListener('scroll', function () { });
                return;
            }
    ...
    function faqSection() {
        ...
        waitForElm('body.spz-14007-tc .spz-faq-sec [class$=CollectionAccordion-root] [class$=CollectionAccordion-itemsContainer] [class$=MuiAccordion-root-CollectionAccordion-accordion] [class$=MuiAccordionSummary-root-CollectionAccordion-accordionSummary] .MuiAccordionSummary-content [class$=CollectionAccordion-title]').then(function () {
