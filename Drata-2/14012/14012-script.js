(function () {
    ...
    function appendScript(url, callback) {
        ...
        css.rel = "stylesheet";
        css.href = "//res.cloudinary.com/spiralyze/raw/upload/f_auto/drata/14007/Swiper/swiper-min.css";
    ...
    appendScript("//res.cloudinary.com/spiralyze/raw/upload/f_auto/drata/14007/Swiper/swiper-min.js", function () {
        initSlider();
    });
    ...
    function createTest() {
        ...
        waitForElm('header + div[data-csk-entry-type="hero"] > .MuiContainer-root').then(function () {
            document.querySelector("body").classList.add("spz-14012");

            if (document.querySelector('body .hero-section-14012')) {
                document.querySelector('body .hero-section-14012').remove();
            }
        ...
        createCookie('spz-14012-loaded', 'true', 1);
    }

    function removeTest() {
        document.body.classList.remove("loaded-test");
        document.body.classList.remove("spz-14012");
        if (document.querySelector('.hero-section-14012')) {
            document.querySelector('.hero-section-14012').remove();
        }
    ...
    function demoChecked() {
        waitForElm('[class*="MuiModal-root"] .hs-form-private').then(function () {
            insertEmailInField();
        });

        const sInt = setInterval(() => {
            var cro_field = document.querySelector('[class*="MuiModal-root"] form.hs-form-private .hs_cro_test_3 .input .hs-input');

            // Check if spz-14012-loaded cookie is present and cro_field is present
            if ((cro_field && cro_field.val != '') && isCookieExist('spz-14012-loaded')) {
                clearInterval(sInt);
                submitTestDetails('Variant_14007');

                // deleteCookie('spz-14012-loaded');
            }
        }, 1000);
    ...
    function heroContent() {
        ...
        if (document.querySelector('body main')) {
            ...
            if (document.querySelectorAll('body .hero-section-14012').length == 0) {
                // clearInterval(appendHero);

                document.querySelector('body main').insertAdjacentHTML("beforebegin", `<section class="hero-section-14012">
                    <div class="hero-content dis-flex flex-wrap justify-content-between">
                    <div class="hero-left-section">
                        <h1 class="hc-title">Accelerate <i class="dynamic-product-name">SOC 2</i> Compliance. <span class="hc-blue">Reduce Time</span> and <span class="hc-blue">Cost</span> by 50%.</h1>
                        <div class="star-rating dis-flex align-items-center"><img src="${astUrl}/fl_sanitize/drata/14001/hero_logo-g2.svg" class="g2-img" alt="G2 Logo" title="G2 Logo" draggable="false">
                            ...
                            <div class="form-group-wrapper">
                                ...
                                <a href="/demo" id="hero-copy-url" class="hero-btn redirect-to-demo spz_tracking_14012">
                ...
                if (document.querySelectorAll('.social-pr-section').length == 0) {
                    document.querySelector('.hero-section-14012').insertAdjacentHTML("afterend", socialProof());
                }
    ...
    function socialProof() {
        return `<section class="social-pr-section">
                <!-- <div class="container"> -->
                <h2 class="sp-title">Join the thousands of companies that trust Drata</h2>
                <div class="sp-logo-group dis-flex justify-content-between">
                  <div class="sp-marquee">
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/abnormal.svg" class="sp-img"
                        alt="Abnormal" title="Abnormal">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/airbase.svg" class="sp-img"
                        alt="Airbase" title="Airbase">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/superhuman_1.svg" class="sp-img"
                        alt="SuperHuman" title="SuperHuman">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/clearbit.svg" class="sp-img"
                        alt="Clearbit" title="Clearbit">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/bamboohr.svg" class="sp-img"
                        alt="bamboo HR" title="bamboo HR">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/notion.svg" class="sp-img"
                        alt="Notion" title="Notion">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/postman.svg" class="sp-img"
                        alt="Postman" title="Postman">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/vercel.svg" class="sp-img"
                        alt="Vercel" title="Vercel">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/lemonade.svg" class="sp-img"
                        alt="Lemonade" title="Lemonade">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/fivetran.svg" class="sp-img"
                        alt="Fivetran" title="Fivetran">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/vip.svg" class="sp-img"
                        alt="Wvip" title="Wvip">
                    </div>
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/clearco.svg" class="sp-img"
                        alt="Clearco" title="Clearco">
                    </div>
                    <!-- Repeat -->
                    <div class="sp-logo-item">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/fl_sanitize/drata/6012/abnormal.svg" class="sp-img"
    ...
    function appendCaseStudies() {
        ...
        // if .case-studies-section + .hero-section-14012 is present  then remove .case-studies-section
        if (document.querySelector('.case-studies-section + .hero-section-14012')) {
            document.querySelector('.case-studies-section').remove();
        }

        if (document.querySelectorAll('.case-studies-section').length === 0) {
            document.querySelector('.social-pr-section').insertAdjacentHTML('afterend', `
    ...
    function videoIntegration() {
        ...
        window.addEventListener('scroll', function () {
            ...
            if (!document.querySelector('.spz-14012')) {
                window.removeEventListener('scroll', function () { });
                return;
            }
    ...
    function storeEmail() {
        const email = document.querySelector('.email-hero-spz');
        const getStarted = document.querySelector('#hero-copy-url');
        try {
    ...
    function insertEmailInField() {
        const ieInt = setInterval(() => {
            const email = document.querySelector('[class*="MuiModal-root"] [name="email"]');
            const variantEmail = document.querySelector('[class*="MuiModal-root"] [name="email"]');
