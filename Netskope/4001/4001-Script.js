		...
		if (!bodyEle.classList.contains('netskope_4001')) {
			...
			<div class="hero_inner">
				<div class="hero_left">
					...
					<div class="hero_left_image"><img src="//res.cloudinary.com/spiralyze/image/upload/v1701333039/netskope/4001/desktop_document_wrapper_2.webp" alt="Magic Quadrant for Security Service Edge">
                </div>
				...
				<div class="hero_right">
					...
					<div class="hero_right_image">
						<div class="hero_right_no_desk_image">
							<picture>
								<source media="(min-width:768px)" srcset="//res.cloudinary.com/spiralyze/image/upload/v1701333039/netskope/4001/tablet_document_wrapper_2.webp">
								<source media="(min-width:320px)" srcset="//res.cloudinary.com/spiralyze/image/upload/v1701333039/netskope/4001/mobile_document_wrapper_2.webp">
								<img src="//res.cloudinary.com/spiralyze/image/upload/v1701333039/netskope/4001/tablet_document_wrapper_2.webp" alt="Magic Quadrant for Security Service Edge">
							</picture>
						</div>
						<div class="sec_image">
							<picture>
