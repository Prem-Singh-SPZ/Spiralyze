    ...
    if (body) {
        ...
        if (!body.classList.contains('spz-8005')) {
            ...
            waitForElm('.spz-8005 .gated-content__top .gated-content__banner').then(function () {
                ...
                //Footer addition
                document.querySelector('.gated-content__container .gated-content__left').insertAdjacentHTML('beforeend', `<div class="spz-footer-section"><div class="footer-container"><div class="u-footer"><div class="nmobile"><img src="//res.cloudinary.com/spiralyze/image/upload/v1706077616/netskope/9001/Call-icon.svg" alt="phone"> USA: +1 (800) 979-6988</div><div class="social-icons"><div class="social-icon icon--facebook"> <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.netskope.com/resources/ebooks/the-6-most-compelling-use-cases-for-complete-legacy-vpn-replacement'"> <img src="//res.cloudinary.com/spiralyze/image/upload/v1708099742/netskope/8005/facebook_logo.svg" class="s-icon" alt="facebook icon"></a></div><div class="social-icon icon--twitter"> <a href="https://twitter.com/share?text= The 6 Most Compelling Use Cases for Complete Legacy VPN Replacement @Netskope&amp;url=https%3A%2F%2Fwww.netskope.com%2Fresources%2Febooks%2Fthe-6-most-compelling-use-cases-for-complete-legacy-vpn-replacement"> <img src="//res.cloudinary.com/spiralyze/image/upload/v1708099742/netskope/8005/x_logo.svg" class="s-icon" alt="twitter icon"></a></div><div class="social-icon icon--linkedin"> <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https://www.netskope.com/resources/ebooks/the-6-most-compelling-use-cases-for-complete-legacy-vpn-replacement'"> <img src="//res.cloudinary.com/spiralyze/image/upload/v1708099742/netskope/8005/linkedin_logo.svg" class="s-icon" alt="twitter icon"></a></div></div></div><div class="l-footer"><ul class="navbar-nav"><li class="menu-item"><a href="https://www.netskope.com/privacy-policy">Privacy Policy</a></li><li class="menu-item"><a href="https://www.netskope.com/vulnerability-disclosure-policy">Vulnerability Disclosure Policy</a></li><li class="menu-item"><a href="https://www.netskope.com/terms-of-use">Terms of Use</a></li><li class="menu-item"><a href="https://www.netskope.com/netskope-technical-support">Support</a></li></ul><div class="v3-footer__date">© 2024, All rights reserved.</div></div></div></div>`);
