...
let bodyLoaded = setInterval(function () {
  ...
  if (body) {
    ...
    function createTest3001() {
      ...
      document.querySelector('.header__get-started').insertAdjacentHTML('afterbegin', '<div class="spz-3003-email"><input class="spz-email" type="email" placeholder="Business email"></div>');

      document.querySelector('.header__top-menu').insertAdjacentHTML('afterend', '<div class="header__get-started mobile"><div class="spz-3003-email"><input class="spz-email mobile" type="email" placeholder="Business email"></div> <a class="header__get-started-button btn" href="https://www.netskope.com/get-started">Get Started</a></div>');

      //Hero section added here
      document.querySelector('#components__content').insertAdjacentHTML('afterbegin', `
          <div class="spz-hero-section">
            <div class="hero-section-wrapper container">
              <div class="hero-section-review">
                  <div class="section-review">
                    <img src="//res.cloudinary.com/spiralyze/image/upload/v1705928768/netskope/3003/gartner_svg.svg" alt="Gartner" class="Gartner">
                    <picture>
                      <img src="//res.cloudinary.com/spiralyze/image/upload/v1705928768/netskope/3003/frame_5597.svg" alt="Star Rating">
                    </picture>
                    <span>4.6</span>
                  </div>
                  <div class="section-review">
                    <img src="//res.cloudinary.com/spiralyze/image/upload/v1705928768/netskope/3003/g2_svg.svg" alt="G2" class="Gartner g2">
                    <picture>
                      <img src="//res.cloudinary.com/spiralyze/image/upload/v1705928768/netskope/3003/frame_5598.svg" alt="Star Rating">
                    </picture>
                    <span>4.4</span>
                  </div>
              </div>
                <div class="hero-section-title">
                    <h2>Secure your entire<br> multi-cloud <span>Environment</span></h2>
                    <p>Lorem ipsum dolor sit amet, consec tetur adipiscing elit. Nam condimentum tempus diam, ultricies sollicitudin erat facilisis eget. </p>
                </div>
                <div class="hero-img-no-desk">
                    <picture>
                      <source media="(min-width:1900)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/netskope/3003/dashboard_1441.webp">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/netskope/3003/dashboard_768.webp" alt="Hero dashboard" class="hin-img">
                    </picture>
                </div>
                <div class="hero-section-CTA">
                    <h4 class="hsc-title">Lorem ipsum dolor sit amet, consec tetur</h4>
                    <form class="form-spz" id="mktoForm_3003" method="GET">
                      <div class="header__get-started">
                        <div class="spz-3003-email">
              ...
              <div class="banner-section container">
                ...
                <div class="banner-images">
                  <picture>
                      ...
                      <source media="(min-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/v1706702754/netskope/3003/Logos_Tablet.svg">
                      <img src="//res.cloudinary.com/spiralyze/image/upload/v1706708220/netskope/3003/Logos_mobile.svg" alt="Our Partners">
                  </picture>
                </div>
              </div>
            </div>
      ...
      waitForElm('.v3-reports.light:not(.control) .v3-reports__title h2').then(function (elm) {
      ...
      // Adding 'sticky-spz' class to body on scroll by 45px
      window.addEventListener('scroll', function () {
        if (window.scrollY > 30) {
          document.body.classList.add('sticky-spz');
        } else {
          document.body.classList.remove('sticky-spz');
        }
      });
    }
    ...
    waitForElm('.spz-email').then(function (elm) {
      ...
      document.querySelector('.get-started-cta').addEventListener('click', function (e) {
        e.preventDefault();
        validateEmailField();
      });
    });
    ...
    function setHiddenFields() {
      if (document.querySelector('.mktoFormRow [name="utm_location__c"]')) {
        document.querySelector('.mktoFormRow [name="utm_location__c"]').setAttribute('value', '#3003_spz_variant');
      } 
    }
  }
});
