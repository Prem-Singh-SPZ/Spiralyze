    ...
    if (!body.classList.contains("netskope_6001")) {
      ...
      waitForElm(".netskope_6001 #wrapper .v3.landing-page-v3__container").then(function () {
        var sub_heading = document.querySelector(
          ".netskope_6001 #wrapper .v3.landing-page-v3__container .landing-page-v3__subheadline"
        ).innerHTML;

        // Hero Fom Content
        document
          .querySelector(".netskope_6001 #wrapper .v3.landing-page-v3__container .landing-page-v3__form")
          .insertAdjacentHTML(
            "afterbegin",
            `<div class="hero_left">
        ...
        document
          .querySelector(".netskope_6001 #wrapper .landing-page-v3__form .landing-page-v3__form-content")
          .insertAdjacentHTML(
            "afterend",
            `<h2 class="form-content-heading">Highest<br> in Execution. Furthest<br> in <span>Vision</span>.</h2>`
          );
...
function formModify() {
  ...
  var parentDiv = document.querySelector(
    ".netskope_6001 .landing-page-v3__form .landing-page-v3__form-content .mktoForm"
  );
  ...
  var form_button = setInterval(() => {
    var textChng = document.querySelector(
      ".netskope_6001 .landing-page-v3__form .landing-page-v3__form-content .mktoForm .mktoButtonRow .mktoButton"
    );
    if (textChng) {
