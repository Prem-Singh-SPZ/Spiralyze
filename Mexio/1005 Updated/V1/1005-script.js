...
function formPage() {
    var iframebodyInterval = setInterval(function () {
        ...
        if (iframebodyEle) {
            if (!iframebodyEle.classList.contains('spz-1005-iframe-V1')) {
                clearInterval(iframebodyInterval);
                iframebodyEle.classList.add('spz-1005-iframe-V1');
...
function demoPage() {
    var bodyInterval = setInterval(function () {
        ...
        if (!bodyEle.classList.contains('spz-1005-demo-V1')) {
            clearInterval(bodyInterval);
            bodyEle.classList.add('spz-1005-demo-V1');
...
function mainPage() {
    var bodyInterval = setInterval(function () {
        var bodyEle = document.querySelector('body');
        if (!bodyEle.classList.contains('spz-1005-v1')) {
            clearInterval(bodyInterval);
            ...
            bodyEle.classList.add('spz-1005-v1');
