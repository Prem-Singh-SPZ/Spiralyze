...
const template_formElements = {
  customHTMLBefore: `
    ...
    <div class="spz-form-heading">Maxio Billing Sandbox</div>
  `,
  customHTMLAfter: ``,
};
...
const formLoaded = setInterval(() => {
  if(document.querySelector(template_formUniqueSelector) && document.querySelectorAll(`${template_formUniqueSelector} select`).length > 0){
