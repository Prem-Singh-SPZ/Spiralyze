let bodyLoaded = setInterval(function () {
    ...
    if (body) {
      ...
      if (!body.classList.contains('spz_1004')) {
        ...
        waitForElm('.spz_1004 #zy-demo-form-section').then(function () {
          document.querySelector('.spz_1004 #zy-demo-form-section .zy-col-text h3').textContent = "Ready to rocket your ROI?";
          document.querySelector('.spz_1004 #zy-demo-form-section .zy-col-text .zy-content').textContent = "Improve efficiency of prospecting and selling. Make smarter decisions with data-driven insights. Increase productivity and achieve profitable growth.";
          //Form internal code
          ...
          waitForElm('.spz_1004 .zy-marketo-form-container .mktoForm input[name="cR02"]').then(function () {
            document.querySelector(`.spz_1004 .zy-marketo-form-container .mktoForm input[name="cR01"]`).setAttribute("value", "1004_variant");
          });
        });
      }
    }
  ...
  function formModify() {
    ...
    var lname_field = document.querySelector('.spz_1004 .mktoFormRow.field-2');
