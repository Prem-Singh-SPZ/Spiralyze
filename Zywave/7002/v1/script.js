...
.spz_7002_V1.show-sticky-bar .spz-sticky-review {
 opacity: 1;
 pointer-events: all; 
}
.spz_7002_V1 .spz-sticky-review .sticky-wrapper {
  display: flex;
  flex-wrap: wrap;
  align-items: center;
...
.spz_7002_V1 .spz-sticky-review .close-icon {
  display: inline-flex;
  flex-wrap: wrap;
  align-items: center;
...
.spz_7002_V1 .spz-sticky-review .close-icon:hover {
  background: #051C2C;
}
.spz_7002_V1 .spz-sticky-review .close-icon svg path {
  transition: all 0.4s ease-in-out;
}
.spz_7002_V1 .spz-sticky-review .close-icon:hover svg path {
  fill: #FFF;
}
.spz_7002_V1 .spz-sticky-review .review-content {
  display: inline-flex;
  flex-wrap: wrap;
  align-items: center;
}
.spz_7002_V1 .spz-sticky-review .review-block {
  margin-top: -3px;
}
.spz_7002_V1 .spz-sticky-review .review-block .review-rating {
  color: #CCCCCC;
  font-size: 14px;
  font-style: normal;
  font-weight: 600;
...
.spz_7002_V1 .spz-sticky-review .review-block .review-rating .avg-rating {
  color: #FFF;
  font-weight: 700;
  margin-right: 2px;
}
.spz_7002_V1 .spz-sticky-review .review-block-heading {
  color: #FFF;
...
.spz_7002_V1 .spz-sticky-review .demo-cta {
  display: inline-flex;
  flex-wrap: wrap;
  align-items: center;
  justify-content: center;
...
.spz_7002_V1 .spz-sticky-review .demo-cta:hover {
  background: #7EDB58;
}
.spz_7002_V1.show-sticky-bar .zy-subfooter {
  padding-bottom: 102px;
}
@media(max-width: 1399.98px) {
  .spz_7002_V1.show-sticky-bar div.embeddedServiceHelpButton .helpButton {
    bottom: 145px;
  }
}
...
@media(max-width: 1023.98px) {
  ...
  .spz_7002_V1 .spz-sticky-review .review-content .review-block {
    display: flex;
    flex-wrap: wrap;
    align-items: center;
  }
  .spz_7002_V1 .spz-sticky-review .review-content .review-block img {
    height: 16px;
    object-fit: contain;
  }
  .spz_7002_V1 .spz-sticky-review .review-block-heading {
...
let bodyLoaded = setInterval(function () {
  ...
  if (body) {
    ...
    if (!body.classList.contains('spz_7002_V1')) {
	    body.classList.add('spz_7002_V1');
		  waitForElm('.spz_7002_V1 footer.zy-footer').then(function () {
        if (document.querySelectorAll(".spz-sticky-review").length == 0) {
          document.querySelector('.spz_7002_V1 footer.zy-footer').insertAdjacentHTML("beforebegin", `<div class="spz-sticky-review">
            <diV class="sticky-wrapper">
              ...
              <div class="review-content">
                ...
                <h4 class="review-block-heading">Streamline every step of insurance lifecycle management</h4>
              </div>
              <div class="demo-cta">Book a demo</div>
            </div>
          </div>`);

          document.querySelector('.spz_7002_V1 .spz-sticky-review .demo-cta').addEventListener('click', () => {
            document.querySelector('.zy-header-bottom-inner .zy-header-bottom-demo>a').click();
          });

          document.querySelector('.spz_7002_V1 .spz-sticky-review .close-icon').addEventListener('click', () => {
        ...
        waitForElm('.spz_7002_V1 .zy-marketo-form-container .mktoForm input[name="cR03"]').then(function () {
          document.querySelector(`.spz_7002_V1 .zy-marketo-form-container .mktoForm input[name="cR03"]`).setAttribute("value", "#7002_variant1");
        });
		  });
    }
  }
