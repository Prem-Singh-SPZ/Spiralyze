...
let bodyLoaded = setInterval(function () {
  ...
  if (body) {
    ...
    if (!body.classList.contains('spz-1010-v2')) {
      body.classList.add('spz-1010-v2');
      createTest();
    }
  }
});
function createTest() {
  waitForElm('#zy-demo-form-section .zy-col-form form.mktoForm .mktoFormCol .mktoFieldWrap input').then(function () {
    ...
    var demo_form = document.querySelector('#zy-demo-form-section');
    var footer = document.querySelector('.zy-subfooter');
    footer.after(demo_form);
    // Add Close Icon
    document.querySelector("#zy-demo-form-section .zy-container").insertAdjacentHTML('afterbegin', `
    ...
    //  Trigger Popup
    var headerCTA = document.querySelectorAll('a[href="#zy-demo-form-section"]');
    ...
    // Close Popup
    document.querySelectorAll('#zy-demo-form-section .close-icon').forEach((ec) => {
      ec.addEventListener("click", () => {
        document.body.classList.remove('show-popup');
      });
    });
    
    document.querySelector('#zy-demo-form-section .zy-container').addEventListener("click", (ev) => {
      ev.stopPropagation();
    });
    formModify();
    ...
    waitForElm('.zy-marketo-form-container .mktoForm input[name="cR01"]').then(function () {
      document.querySelector(`.zy-marketo-form-container .mktoForm input[name="cR01"]`).setAttribute("value", "1010_variant_v2");
    });
  });
}
function formModify() {
