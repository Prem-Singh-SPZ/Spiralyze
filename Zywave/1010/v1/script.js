...
function createTest() {
  waitForElm('#zy-demo-form-section').then(function () {
    document.querySelector('#zy-demo-form-section .zy-col-text h3').textContent = "Ready to rocket your ROI?";
    document.querySelector('#zy-demo-form-section .zy-col-text .zy-content').textContent = "Improve efficiency of prospecting and selling. Make smarter decisions with data-driven insights. Increase productivity and achieve profitable growth.";
    //Form internal code
