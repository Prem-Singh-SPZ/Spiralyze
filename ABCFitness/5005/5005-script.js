(function () {
    ...
    function heroContentUpdate() {
        ...
        document.querySelector('main.l-body-wrapper .c-hero__content .c-hero__info-wrapper .c-hero__title-wrapper .c-hero__title').innerHTML = `<strong>See why 40% of <br>gyms </strong>use our gym management software.`;
        document.querySelector('main.l-body-wrapper .c-hero__content .c-hero__info-wrapper .c-hero__subtitle .p1').innerHTML = `Gyms grow revenue up to 30% by automating sales, operations, and member management. See how we can help you.`;
