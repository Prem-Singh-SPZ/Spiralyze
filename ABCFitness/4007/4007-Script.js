(function () {
    ...
    function loadTest() {
        ...
        waitForElm('body.page-child.member-management main.l-body-wrapper footer.l-footer').then(function () {
            stickyFooter();
        });
        waitForElm('body.page-child.member-management main.l-body-wrapper .spz-sticky-footer').then(function () {
    ...
    function stickyFooter() {
        if (document.querySelectorAll('body.page-child.member-management main.l-body-wrapper .spz-sticky-footer').length == 0) {
            document.querySelector('body.page-child.member-management main.l-body-wrapper footer.l-footer').insertAdjacentHTML('afterend', `<div class="spz-sticky-footer">
