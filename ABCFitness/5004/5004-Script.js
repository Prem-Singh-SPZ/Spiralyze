(function () {
    const TEST_ENV = {
        name: 'spz-home-hero-copy-change-5004',
        class: 'spz-5004',
        date: '25-04-23',
    ...
    function heroContentUpdate() {
        ...
        document.querySelector('main.l-body-wrapper .c-hero__content .c-hero__info-wrapper .c-hero__title-wrapper .c-hero__title').innerHTML = `<strong>#1 club & gym management platform</strong>`;
        document.querySelector('main.l-body-wrapper .c-hero__content .c-hero__info-wrapper .c-hero__subtitle .p1').innerHTML = `Grow your gym 30% while streamlining sales, member engagement, and operations.`;
    }
