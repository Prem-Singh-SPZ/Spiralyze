...
function loadTest() {
    ...
    waitForElm('.l-body-wrapper .c-hero__content').then(function () {
        document.querySelector('.l-body-wrapper .c-hero__content .c-hero__info-wrapper .c-hero__subtitle.c-subtitle').insertAdjacentHTML('beforeend', `<a class="book-a-demo-btn c-grid-simple__btn c-btn--internal-type  c-btn c-btn--primary " href="https://abcfitness.com/solutions/">
        BOOK A DEMO
    </a>`);
        headerChange();
    });
